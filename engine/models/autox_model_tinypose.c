...
void tinypose_128x96(const float* x, const uint16_t ssize_h, const uint16_t ssize_w, void* weights, float* Out)
{
	...
	autox_elementwise_add(transpose_4_tmp_0, transpose_4_tmp_0, tmp_0, reshape2_5_tmp_0_dim, reshape2_5_tmp_0_dim, tmp_0_dim, -1, 4, 4, 4);
	free(transpose_4_tmp_0);
	//free(transpose_4_tmp_0);

	float* batch_norm_22_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(tmp_0, (float*)((int8_t*)weights) + 16760, (float*)((int8_t*)weights) + 16800, batch_norm_22_tmp_2, reshape2_9_tmp_0_dim, conv2d_22_w_0_dim, batch_norm_22_tmp_2_dim, 1, 0, 1, 1, 0);
	free(tmp_0);
	...
	//autox_elementwise_add(reshape2_13_tmp_0, reshape2_13_tmp_0, tmp_4, reshape2_13_tmp_0_dim, reshape2_13_tmp_0_dim, tmp_4_dim, -1, 4, 4, 4);
	//free(reshape2_13_tmp_0);
	//free(reshape2_13_tmp_0);

	//float* batch_norm_37_tmp_2 = (float*)calloc(7680, sizeof(float));
	//autox_conv2d(reshape2_17_tmp_0, (float*)((int8_t*)weights) + 33120, (float*)((int8_t*)weights) + 33160, batch_norm_37_tmp_2, reshape2_17_tmp_0_dim, conv2d_37_w_0_dim, batch_norm_37_tmp_2_dim, 1, 0, 1, 1, 0);
	...
	//autox_elementwise_add(reshape2_21_tmp_0, reshape2_21_tmp_0, tmp_8, reshape2_21_tmp_0_dim, reshape2_21_tmp_0_dim, tmp_8_dim, -1, 4, 4, 4);
	//free(reshape2_21_tmp_0);
	//free(reshape2_21_tmp_0);

	//float* batch_norm_60_tmp_2 = (float*)calloc(7680, sizeof(float));
	//autox_conv2d(reshape2_25_tmp_0, (float*)((int8_t*)weights) + 90760, (float*)((int8_t*)weights) + 90800, batch_norm_60_tmp_2, reshape2_25_tmp_0_dim, conv2d_60_w_0_dim, batch_norm_60_tmp_2_dim, 1, 0, 1, 1, 0);
	...
	//autox_conv2d(reshape2_29_tmp_0, (float*)((int8_t*)weights) + 94000, (float*)((int8_t*)weights) + 94040, batch_norm_61_tmp_2, reshape2_29_tmp_0_dim, conv2d_61_w_0_dim, batch_norm_61_tmp_2_dim, 1, 0, 1, 1, 0);
	...
	//autox_elementwise_add(tmp_11, reshape2_25_tmp_0, tmp_12, tmp_11_dim, reshape2_25_tmp_0_dim, tmp_12_dim, -1, 4, 4, 4);
	//free(tmp_11);
	//free(reshape2_25_tmp_0);

	//float* batch_norm_64_tmp_2 = (float*)calloc(3840, sizeof(float));
	//autox_conv2d(reshape2_29_tmp_0, (float*)((int8_t*)weights) + 104120, (float*)((int8_t*)weights) + 104200, batch_norm_64_tmp_2, reshape2_29_tmp_0_dim, conv2d_64_w_0_dim, batch_norm_64_tmp_2_dim, 1, 0, 1, 1, 0);
	//free(reshape2_29_tmp_0);
	...
	//autox_conv2d(reshape2_25_tmp_0, (float*)((int8_t*)weights) + 126000, (float*)((int8_t*)weights) + 126080, batch_norm_69_tmp_2, reshape2_25_tmp_0_dim, conv2d_69_w_0_dim, batch_norm_69_tmp_2_dim, 80, 1, 2, 1, 0);
	//free(reshape2_25_tmp_0);
	...
	//autox_elementwise_add(reshape2_33_tmp_0, reshape2_33_tmp_0, tmp_17, reshape2_33_tmp_0_dim, reshape2_33_tmp_0_dim, tmp_17_dim, -1, 4, 4, 4);
	//free(reshape2_33_tmp_0);
	//free(reshape2_33_tmp_0);

	//float* batch_norm_89_tmp_2 = (float*)calloc(7680, sizeof(float));
	//autox_conv2d(reshape2_37_tmp_0, (float*)((int8_t*)weights) + 176720, (float*)((int8_t*)weights) + 176760, batch_norm_89_tmp_2, reshape2_37_tmp_0_dim, conv2d_89_w_0_dim, batch_norm_89_tmp_2_dim, 1, 0, 1, 1, 0);
	...
	//autox_conv2d(reshape2_41_tmp_0, (float*)((int8_t*)weights) + 179960, (float*)((int8_t*)weights) + 180000, batch_norm_90_tmp_2, reshape2_41_tmp_0_dim, conv2d_90_w_0_dim, batch_norm_90_tmp_2_dim, 1, 0, 1, 1, 0);
	...
	//autox_elementwise_add(tmp_20, reshape2_37_tmp_0, tmp_21, tmp_20_dim, reshape2_37_tmp_0_dim, tmp_21_dim, -1, 4, 4, 4);
	//free(tmp_20);
	//free(reshape2_37_tmp_0);

	//float* batch_norm_93_tmp_2 = (float*)calloc(3840, sizeof(float));
	//autox_conv2d(reshape2_41_tmp_0, (float*)((int8_t*)weights) + 190080, (float*)((int8_t*)weights) + 190160, batch_norm_93_tmp_2, reshape2_41_tmp_0_dim, conv2d_93_w_0_dim, batch_norm_93_tmp_2_dim, 1, 0, 1, 1, 0);
	//free(reshape2_41_tmp_0);
	...
	//autox_conv2d(reshape2_37_tmp_0, (float*)((int8_t*)weights) + 211960, (float*)((int8_t*)weights) + 212040, batch_norm_98_tmp_2, reshape2_37_tmp_0_dim, conv2d_98_w_0_dim, batch_norm_98_tmp_2_dim, 80, 1, 2, 1, 0);
	//free(reshape2_37_tmp_0);
	...
	//autox_elementwise_add(reshape2_45_tmp_0, reshape2_45_tmp_0, tmp_26, reshape2_45_tmp_0_dim, reshape2_45_tmp_0_dim, tmp_26_dim, -1, 4, 4, 4);
	//free(reshape2_45_tmp_0);
	//free(reshape2_45_tmp_0);

	//float* batch_norm_118_tmp_2 = (float*)calloc(7680, sizeof(float));
	//autox_conv2d(reshape2_49_tmp_0, (float*)((int8_t*)weights) + 262680, (float*)((int8_t*)weights) + 262720, batch_norm_118_tmp_2, reshape2_49_tmp_0_dim, conv2d_118_w_0_dim, batch_norm_118_tmp_2_dim, 1, 0, 1, 1, 0);
	...
	//autox_conv2d(reshape2_53_tmp_0, (float*)((int8_t*)weights) + 265920, (float*)((int8_t*)weights) + 265960, batch_norm_119_tmp_2, reshape2_53_tmp_0_dim, conv2d_119_w_0_dim, batch_norm_119_tmp_2_dim, 1, 0, 1, 1, 0);
	...
	//autox_elementwise_add(tmp_29, reshape2_49_tmp_0, tmp_30, tmp_29_dim, reshape2_49_tmp_0_dim, tmp_30_dim, -1, 4, 4, 4);
	//free(tmp_29);
	//free(reshape2_49_tmp_0);

	//float* batch_norm_122_tmp_2 = (float*)calloc(3840, sizeof(float));
	//autox_conv2d(reshape2_53_tmp_0, (float*)((int8_t*)weights) + 276040, (float*)((int8_t*)weights) + 276120, batch_norm_122_tmp_2, reshape2_53_tmp_0_dim, conv2d_122_w_0_dim, batch_norm_122_tmp_2_dim, 1, 0, 1, 1, 0);
	//free(reshape2_53_tmp_0);
	...
	//autox_conv2d(reshape2_49_tmp_0, (float*)((int8_t*)weights) + 297920, (float*)((int8_t*)weights) + 298000, batch_norm_127_tmp_2, reshape2_49_tmp_0_dim, conv2d_127_w_0_dim, batch_norm_127_tmp_2_dim, 80, 1, 2, 1, 0);
	//free(reshape2_49_tmp_0);
	...
	//autox_elementwise_add(reshape2_57_tmp_0, reshape2_57_tmp_0, tmp_35, reshape2_57_tmp_0_dim, reshape2_57_tmp_0_dim, tmp_35_dim, -1, 4, 4, 4);
	//free(reshape2_57_tmp_0);
	//free(reshape2_57_tmp_0);

	//float* batch_norm_147_tmp_2 = (float*)calloc(7680, sizeof(float));
	//autox_conv2d(reshape2_61_tmp_0, (float*)((int8_t*)weights) + 348640, (float*)((int8_t*)weights) + 348680, batch_norm_147_tmp_2, reshape2_61_tmp_0_dim, conv2d_147_w_0_dim, batch_norm_147_tmp_2_dim, 1, 0, 1, 1, 0);
	...
	//autox_conv2d(reshape2_65_tmp_0, (float*)((int8_t*)weights) + 351880, (float*)((int8_t*)weights) + 351920, batch_norm_148_tmp_2, reshape2_65_tmp_0_dim, conv2d_148_w_0_dim, batch_norm_148_tmp_2_dim, 1, 0, 1, 1, 0);
	...
	//autox_elementwise_add(tmp_38, reshape2_61_tmp_0, tmp_39, tmp_38_dim, reshape2_61_tmp_0_dim, tmp_39_dim, -1, 4, 4, 4);
	//free(tmp_38);
	//free(reshape2_61_tmp_0);

	//float* batch_norm_151_tmp_2 = (float*)calloc(3840, sizeof(float));
	//autox_conv2d(reshape2_65_tmp_0, (float*)((int8_t*)weights) + 362000, (float*)((int8_t*)weights) + 362080, batch_norm_151_tmp_2, reshape2_65_tmp_0_dim, conv2d_151_w_0_dim, batch_norm_151_tmp_2_dim, 1, 0, 1, 1, 0);
	//free(reshape2_65_tmp_0);
	...
	//autox_conv2d(reshape2_61_tmp_0, (float*)((int8_t*)weights) + 383880, (float*)((int8_t*)weights) + 383960, batch_norm_156_tmp_2, reshape2_61_tmp_0_dim, conv2d_156_w_0_dim, batch_norm_156_tmp_2_dim, 80, 1, 2, 1, 0);
	//free(reshape2_61_tmp_0);
	...
	//autox_elementwise_add(reshape2_69_tmp_0, reshape2_69_tmp_0, tmp_44, reshape2_69_tmp_0_dim, reshape2_69_tmp_0_dim, tmp_44_dim, -1, 4, 4, 4);
	//free(reshape2_69_tmp_0);
	//free(reshape2_69_tmp_0);

	//float* batch_norm_184_tmp_2 = (float*)calloc(7680, sizeof(float));
	//autox_conv2d(reshape2_73_tmp_0, (float*)((int8_t*)weights) + 593960, (float*)((int8_t*)weights) + 594000, batch_norm_184_tmp_2, reshape2_73_tmp_0_dim, conv2d_184_w_0_dim, batch_norm_184_tmp_2_dim, 1, 0, 1, 1, 0);
	...
	//autox_conv2d(reshape2_77_tmp_0, (float*)((int8_t*)weights) + 597200, (float*)((int8_t*)weights) + 597240, batch_norm_185_tmp_2, reshape2_77_tmp_0_dim, conv2d_185_w_0_dim, batch_norm_185_tmp_2_dim, 1, 0, 1, 1, 0);
	...
	//autox_conv2d(reshape2_81_tmp_0, (float*)((int8_t*)weights) + 603640, (float*)((int8_t*)weights) + 603680, batch_norm_186_tmp_2, reshape2_81_tmp_0_dim, conv2d_186_w_0_dim, batch_norm_186_tmp_2_dim, 1, 0, 1, 1, 0);
	...
	//autox_elementwise_add(tmp_48, reshape2_73_tmp_0, tmp_49, tmp_48_dim, reshape2_73_tmp_0_dim, tmp_49_dim, -1, 4, 4, 4);
	//free(tmp_48);
	//free(reshape2_73_tmp_0);

	//float* batch_norm_189_tmp_2 = (float*)calloc(3840, sizeof(float));
	//autox_conv2d(reshape2_77_tmp_0, (float*)((int8_t*)weights) + 620160, (float*)((int8_t*)weights) + 620240, batch_norm_189_tmp_2, reshape2_77_tmp_0_dim, conv2d_189_w_0_dim, batch_norm_189_tmp_2_dim, 1, 0, 1, 1, 0);
	//free(reshape2_77_tmp_0);
	...
	//autox_conv2d(reshape2_81_tmp_0, (float*)((int8_t*)weights) + 633040, (float*)((int8_t*)weights) + 633120, batch_norm_190_tmp_2, reshape2_81_tmp_0_dim, conv2d_190_w_0_dim, batch_norm_190_tmp_2_dim, 1, 0, 1, 1, 0);
	//free(reshape2_81_tmp_0);
	...
	//autox_conv2d(reshape2_73_tmp_0, (float*)((int8_t*)weights) + 667720, (float*)((int8_t*)weights) + 667800, batch_norm_195_tmp_2, reshape2_73_tmp_0_dim, conv2d_195_w_0_dim, batch_norm_195_tmp_2_dim, 80, 1, 2, 1, 0);
	//free(reshape2_73_tmp_0);
	...
	//autox_elementwise_add(tmp_53, reshape2_77_tmp_0, tmp_54, tmp_53_dim, reshape2_77_tmp_0_dim, tmp_54_dim, -1, 4, 4, 4);
	//free(tmp_53);
	//free(reshape2_77_tmp_0);

	//float* batch_norm_197_tmp_2 = (float*)calloc(1920, sizeof(float));
	//autox_conv2d(reshape2_81_tmp_0, (float*)((int8_t*)weights) + 681480, (float*)((int8_t*)weights) + 681640, batch_norm_197_tmp_2, reshape2_81_tmp_0_dim, conv2d_197_w_0_dim, batch_norm_197_tmp_2_dim, 1, 0, 1, 1, 0);
	//free(reshape2_81_tmp_0);
	...
	//autox_conv2d(reshape2_73_tmp_0, (float*)((int8_t*)weights) + 750440, (float*)((int8_t*)weights) + 750520, batch_norm_204_tmp_2, reshape2_73_tmp_0_dim, conv2d_204_w_0_dim, batch_norm_204_tmp_2_dim, 80, 1, 2, 1, 0);
	//free(reshape2_73_tmp_0);
	...
	//autox_conv2d(reshape2_77_tmp_0, (float*)((int8_t*)weights) + 784440, (float*)((int8_t*)weights) + 784600, batch_norm_208_tmp_2, reshape2_77_tmp_0_dim, conv2d_208_w_0_dim, batch_norm_208_tmp_2_dim, 160, 1, 2, 1, 0);
	//free(reshape2_77_tmp_0);
	...
	//autox_elementwise_add(reshape2_85_tmp_0, reshape2_85_tmp_0, tmp_60, reshape2_85_tmp_0_dim, reshape2_85_tmp_0_dim, tmp_60_dim, -1, 4, 4, 4);
	//free(reshape2_85_tmp_0);
	//free(reshape2_85_tmp_0);

	//float* batch_norm_234_tmp_2 = (float*)calloc(7680, sizeof(float));
	//autox_conv2d(reshape2_89_tmp_0, (float*)((int8_t*)weights) + 980760, (float*)((int8_t*)weights) + 980800, batch_norm_234_tmp_2, reshape2_89_tmp_0_dim, conv2d_234_w_0_dim, batch_norm_234_tmp_2_dim, 1, 0, 1, 1, 0);
	...
	//autox_conv2d(reshape2_93_tmp_0, (float*)((int8_t*)weights) + 984000, (float*)((int8_t*)weights) + 984040, batch_norm_235_tmp_2, reshape2_93_tmp_0_dim, conv2d_235_w_0_dim, batch_norm_235_tmp_2_dim, 1, 0, 1, 1, 0);
	...
	//autox_conv2d(reshape2_97_tmp_0, (float*)((int8_t*)weights) + 990440, (float*)((int8_t*)weights) + 990480, batch_norm_236_tmp_2, reshape2_97_tmp_0_dim, conv2d_236_w_0_dim, batch_norm_236_tmp_2_dim, 1, 0, 1, 1, 0);
	...
	//autox_elementwise_add(tmp_64, reshape2_89_tmp_0, tmp_65, tmp_64_dim, reshape2_89_tmp_0_dim, tmp_65_dim, -1, 4, 4, 4);
	//free(tmp_64);
	//free(reshape2_89_tmp_0);

	//float* batch_norm_239_tmp_2 = (float*)calloc(3840, sizeof(float));
	//autox_conv2d(reshape2_93_tmp_0, (float*)((int8_t*)weights) + 1006960, (float*)((int8_t*)weights) + 1007040, batch_norm_239_tmp_2, reshape2_93_tmp_0_dim, conv2d_239_w_0_dim, batch_norm_239_tmp_2_dim, 1, 0, 1, 1, 0);
	//free(reshape2_93_tmp_0);
	...
	//autox_conv2d(reshape2_97_tmp_0, (float*)((int8_t*)weights) + 1019840, (float*)((int8_t*)weights) + 1019920, batch_norm_240_tmp_2, reshape2_97_tmp_0_dim, conv2d_240_w_0_dim, batch_norm_240_tmp_2_dim, 1, 0, 1, 1, 0);
	//free(reshape2_97_tmp_0);
	...
	//autox_conv2d(reshape2_89_tmp_0, (float*)((int8_t*)weights) + 1054520, (float*)((int8_t*)weights) + 1054600, batch_norm_245_tmp_2, reshape2_89_tmp_0_dim, conv2d_245_w_0_dim, batch_norm_245_tmp_2_dim, 80, 1, 2, 1, 0);
	//free(reshape2_89_tmp_0);
	...
	//autox_elementwise_add(tmp_69, reshape2_93_tmp_0, tmp_70, tmp_69_dim, reshape2_93_tmp_0_dim, tmp_70_dim, -1, 4, 4, 4);
	//free(tmp_69);
	//free(reshape2_93_tmp_0);

	//float* batch_norm_247_tmp_2 = (float*)calloc(1920, sizeof(float));
	//autox_conv2d(reshape2_97_tmp_0, (float*)((int8_t*)weights) + 1068280, (float*)((int8_t*)weights) + 1068440, batch_norm_247_tmp_2, reshape2_97_tmp_0_dim, conv2d_247_w_0_dim, batch_norm_247_tmp_2_dim, 1, 0, 1, 1, 0);
	//free(reshape2_97_tmp_0);
	...
	//autox_conv2d(reshape2_89_tmp_0, (float*)((int8_t*)weights) + 1137240, (float*)((int8_t*)weights) + 1137320, batch_norm_254_tmp_2, reshape2_89_tmp_0_dim, conv2d_254_w_0_dim, batch_norm_254_tmp_2_dim, 80, 1, 2, 1, 0);
	//free(reshape2_89_tmp_0);
	...
	//autox_conv2d(reshape2_93_tmp_0, (float*)((int8_t*)weights) + 1171240, (float*)((int8_t*)weights) + 1171400, batch_norm_258_tmp_2, reshape2_93_tmp_0_dim, conv2d_258_w_0_dim, batch_norm_258_tmp_2_dim, 160, 1, 2, 1, 0);
	//free(reshape2_93_tmp_0);
	...
	//autox_bilinear_interp(relu_140_tmp_0, bilinear_interp_v2_0_tmp_0, relu_140_tmp_0_dim, bilinear_interp_v2_0_tmp_0_dim, , 1);
	//free(relu_140_tmp_0);
	...
	//autox_bilinear_interp(relu_141_tmp_0, bilinear_interp_v2_1_tmp_0, relu_141_tmp_0_dim, bilinear_interp_v2_1_tmp_0_dim, , 1);
	//free(relu_141_tmp_0);
	...
	//autox_bilinear_interp(relu_142_tmp_0, bilinear_interp_v2_2_tmp_0, relu_142_tmp_0_dim, bilinear_interp_v2_2_tmp_0_dim, , 1);
	//free(relu_142_tmp_0);
	...
	//float* argmax_0_tmp_0 = (float*)calloc(17, sizeof(float));
