...
void tinypose_128x96(const uint8_t* image, const uint16_t ssize_h, const uint16_t ssize_w, float* weights, float* Out)
{
	...
	uint16_t conv2d_268_b_0_dim[] = { 6 };
	uint16_t conv2d_268_w_0_dim[] = { 6, 40, 1, 1 };
	uint16_t conv2d_441_tmp_1_dim[] = { 1, 6, 32, 24 };
	uint16_t shape_53_tmp_0_dim[] = { 4 };
	uint16_t shape_53_tmp_0_slice_0_dim[] = { 1 };
	uint16_t reshape2_98_tmp_0_dim[] = { 1, 6, 768 };
	uint16_t reshape2_98_tmp_1_dim[] = { 0, 1, 6, 32, 24 };
	uint16_t argmax_0_tmp_0_dim[] = { 1, 6 };

	float* relu_0_tmp_0 = (float*)calloc(98304, sizeof(float));
	autox_conv2d(image, weights + 0, weights + 32, relu_0_tmp_0, image_dim, conv2d_0_w_0_dim, relu_0_tmp_0_dim, 1, 1, 2, 1, 1);
	free(image);
	...
	autox_conv2d(split_0_tmp_0, weights + 896, weights + 912, batch_norm_1_tmp_2, split_0_tmp_0_dim, conv2d_1_w_0_dim, batch_norm_1_tmp_2_dim, 16, 1, 2, 1, 0);
	free(split_0_tmp_0);

	float* relu_2_tmp_0 = (float*)calloc(98304, sizeof(float));
	autox_conv2d(split_0_tmp_1, weights + 1056, weights + 1088, relu_2_tmp_0, split_0_tmp_1_dim, conv2d_3_w_0_dim, relu_2_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_0_tmp_1);

	float* batch_norm_4_tmp_2 = (float*)calloc(24576, sizeof(float));
	autox_conv2d(relu_2_tmp_0, weights + 1600, weights + 1632, batch_norm_4_tmp_2, relu_2_tmp_0_dim, conv2d_4_w_0_dim, batch_norm_4_tmp_2_dim, 32, 1, 2, 1, 0);
	free(relu_2_tmp_0);

	float* relu_1_tmp_0 = (float*)calloc(12288, sizeof(float));
	autox_conv2d(batch_norm_1_tmp_2, weights + 1920, weights + 1936, relu_1_tmp_0, batch_norm_1_tmp_2_dim, conv2d_2_w_0_dim, relu_1_tmp_0_dim, 1, 0, 1, 1, 1);
	free(batch_norm_1_tmp_2);

	float* relu_3_tmp_0 = (float*)calloc(12288, sizeof(float));
	autox_conv2d(batch_norm_4_tmp_2, weights + 2192, weights + 2208, relu_3_tmp_0, batch_norm_4_tmp_2_dim, conv2d_5_w_0_dim, relu_3_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_0_tmp_0, transpose_0_tmp_0, reshape2_0_tmp_0_dim, transpose_0_tmp_0_dim, axis_8, 5);
	free(reshape2_0_tmp_0);

	float* batch_norm_6_tmp_2 = (float*)calloc(24576, sizeof(float));
	autox_conv2d(reshape2_1_tmp_0, weights + 2720, weights + 2752, batch_norm_6_tmp_2, reshape2_1_tmp_0_dim, conv2d_6_w_0_dim, batch_norm_6_tmp_2_dim, 32, 1, 1, 1, 0);
	free(reshape2_1_tmp_0);

	float* batch_norm_8_tmp_2 = (float*)calloc(6144, sizeof(float));
	autox_conv2d(reshape2_1_tmp_0, weights + 3040, weights + 3072, batch_norm_8_tmp_2, reshape2_1_tmp_0_dim, conv2d_8_w_0_dim, batch_norm_8_tmp_2_dim, 32, 1, 2, 1, 0);
	free(reshape2_1_tmp_0);

	float* relu_4_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_conv2d(batch_norm_6_tmp_2, weights + 3360, weights + 3400, relu_4_tmp_0, batch_norm_6_tmp_2_dim, conv2d_7_w_0_dim, relu_4_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_conv2d(split_1_tmp_1, weights + 4680, weights + 4700, relu_6_tmp_0, split_1_tmp_1_dim, conv2d_10_w_0_dim, relu_6_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_1_tmp_1);

	float* batch_norm_11_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(relu_6_tmp_0, weights + 5100, weights + 5120, batch_norm_11_tmp_2, relu_6_tmp_0_dim, conv2d_11_w_0_dim, batch_norm_11_tmp_2_dim, 20, 1, 1, 1, 0);
	free(relu_6_tmp_0);

	float* relu_7_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_11_tmp_2, weights + 5300, weights + 5320, relu_7_tmp_0, batch_norm_11_tmp_2_dim, conv2d_12_w_0_dim, relu_7_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_2_tmp_0, transpose_1_tmp_0, reshape2_2_tmp_0_dim, transpose_1_tmp_0_dim, axis_17, 5);
	...
	autox_split(reshape2_3_tmp_0, p_18, reshape2_3_tmp_0_dim, p_18_dim, 1, 4, 2, 4);
	free(reshape2_3_tmp_0);

	float* relu_8_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(split_2_tmp_1, weights + 5720, weights + 5740, relu_8_tmp_0, split_2_tmp_1_dim, conv2d_13_w_0_dim, relu_8_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_2_tmp_1);

	float* batch_norm_14_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(relu_8_tmp_0, weights + 6140, weights + 6160, batch_norm_14_tmp_2, relu_8_tmp_0_dim, conv2d_14_w_0_dim, batch_norm_14_tmp_2_dim, 20, 1, 1, 1, 0);
	free(relu_8_tmp_0);

	float* relu_9_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_14_tmp_2, weights + 6340, weights + 6360, relu_9_tmp_0, batch_norm_14_tmp_2_dim, conv2d_15_w_0_dim, relu_9_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_4_tmp_0, transpose_2_tmp_0, reshape2_4_tmp_0_dim, transpose_2_tmp_0_dim, axis_23, 5);
	free(reshape2_4_tmp_0);

	float* relu_5_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_8_tmp_2, weights + 6760, weights + 6840, relu_5_tmp_0, batch_norm_8_tmp_2_dim, conv2d_9_w_0_dim, relu_5_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_conv2d(split_3_tmp_1, weights + 9400, weights + 9440, relu_10_tmp_0, split_3_tmp_1_dim, conv2d_16_w_0_dim, relu_10_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_3_tmp_1);

	float* batch_norm_17_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(relu_10_tmp_0, weights + 11040, weights + 11080, batch_norm_17_tmp_2, relu_10_tmp_0_dim, conv2d_17_w_0_dim, batch_norm_17_tmp_2_dim, 40, 1, 1, 1, 0);
	free(relu_10_tmp_0);

	float* relu_11_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_17_tmp_2, weights + 11440, weights + 11480, relu_11_tmp_0, batch_norm_17_tmp_2_dim, conv2d_18_w_0_dim, relu_11_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_6_tmp_0, transpose_3_tmp_0, reshape2_6_tmp_0_dim, transpose_3_tmp_0_dim, axis_30, 5);
	...
	autox_split(reshape2_7_tmp_0, p_31, reshape2_7_tmp_0_dim, p_31_dim, 1, 4, 2, 4);
	free(reshape2_7_tmp_0);

	float* relu_12_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(split_4_tmp_1, weights + 13080, weights + 13120, relu_12_tmp_0, split_4_tmp_1_dim, conv2d_19_w_0_dim, relu_12_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_4_tmp_1);

	float* batch_norm_20_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(relu_12_tmp_0, weights + 14720, weights + 14760, batch_norm_20_tmp_2, relu_12_tmp_0_dim, conv2d_20_w_0_dim, batch_norm_20_tmp_2_dim, 40, 1, 1, 1, 0);
	free(relu_12_tmp_0);

	float* relu_13_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_20_tmp_2, weights + 15120, weights + 15160, relu_13_tmp_0, batch_norm_20_tmp_2_dim, conv2d_21_w_0_dim, relu_13_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_8_tmp_0, transpose_4_tmp_0, reshape2_8_tmp_0_dim, transpose_4_tmp_0_dim, axis_36, 5);
	free(reshape2_8_tmp_0);

	float* tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(reshape2_5_tmp_0, reshape2_5_tmp_0, tmp_0, reshape2_5_tmp_0_dim, reshape2_5_tmp_0_dim, tmp_0_dim, -1, 4, 4);
	free(reshape2_5_tmp_0);
	free(reshape2_5_tmp_0);

	float* batch_norm_22_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(reshape2_9_tmp_0, weights + 16760, weights + 16800, batch_norm_22_tmp_2, reshape2_9_tmp_0_dim, conv2d_22_w_0_dim, batch_norm_22_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_9_tmp_0);

	float* nearest_interp_v2_0_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_nearest_interp_v2(batch_norm_22_tmp_2, nearest_interp_v2_0_tmp_0, batch_norm_22_tmp_2_dim, nearest_interp_v2_0_tmp_0_dim);
	free(batch_norm_22_tmp_2);

	float* tmp_1 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(tmp_0, nearest_interp_v2_0_tmp_0, tmp_1, tmp_0_dim, nearest_interp_v2_0_tmp_0_dim, tmp_1_dim, -1, 4, 4);
	free(tmp_0);
	free(nearest_interp_v2_0_tmp_0);

	float* relu_14_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_relu(tmp_1, relu_14_tmp_0, tmp_1_dim, relu_14_tmp_0_dim);
	free(tmp_1);

	float* batch_norm_23_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(tmp_1, weights + 20000, weights + 20040, batch_norm_23_tmp_2, tmp_1_dim, conv2d_23_w_0_dim, batch_norm_23_tmp_2_dim, 40, 1, 2, 1, 0);
	free(tmp_1);

	float* batch_norm_24_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_23_tmp_2, weights + 20400, weights + 20480, batch_norm_24_tmp_2, batch_norm_23_tmp_2_dim, conv2d_24_w_0_dim, batch_norm_24_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_23_tmp_2);

	float* tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_elementwise_add(batch_norm_24_tmp_2, batch_norm_24_tmp_2, tmp_2, batch_norm_24_tmp_2_dim, batch_norm_24_tmp_2_dim, tmp_2_dim, -1, 4, 4);
	...
	autox_conv2d(split_5_tmp_1, weights + 23680, weights + 23700, relu_16_tmp_0, split_5_tmp_1_dim, conv2d_25_w_0_dim, relu_16_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_5_tmp_1);

	float* batch_norm_26_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(relu_16_tmp_0, weights + 24100, weights + 24120, batch_norm_26_tmp_2, relu_16_tmp_0_dim, conv2d_26_w_0_dim, batch_norm_26_tmp_2_dim, 20, 1, 1, 1, 0);
	free(relu_16_tmp_0);

	float* relu_17_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_26_tmp_2, weights + 24300, weights + 24320, relu_17_tmp_0, batch_norm_26_tmp_2_dim, conv2d_27_w_0_dim, relu_17_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_10_tmp_0, transpose_5_tmp_0, reshape2_10_tmp_0_dim, transpose_5_tmp_0_dim, axis_50, 5);
	...
	autox_split(reshape2_11_tmp_0, p_51, reshape2_11_tmp_0_dim, p_51_dim, 1, 4, 2, 4);
	free(reshape2_11_tmp_0);

	float* relu_18_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(split_6_tmp_1, weights + 24720, weights + 24740, relu_18_tmp_0, split_6_tmp_1_dim, conv2d_28_w_0_dim, relu_18_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_6_tmp_1);

	float* batch_norm_29_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(relu_18_tmp_0, weights + 25140, weights + 25160, batch_norm_29_tmp_2, relu_18_tmp_0_dim, conv2d_29_w_0_dim, batch_norm_29_tmp_2_dim, 20, 1, 1, 1, 0);
	free(relu_18_tmp_0);

	float* relu_19_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_29_tmp_2, weights + 25340, weights + 25360, relu_19_tmp_0, batch_norm_29_tmp_2_dim, conv2d_30_w_0_dim, relu_19_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_12_tmp_0, transpose_6_tmp_0, reshape2_12_tmp_0_dim, transpose_6_tmp_0_dim, axis_56, 5);
	free(reshape2_12_tmp_0);

	float* relu_15_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_fusion_elementwise_add_activation(tmp_2, reshape2_9_tmp_0, relu_15_tmp_0, tmp_2_dim, reshape2_9_tmp_0_dim, relu_15_tmp_0_dim, "relu", -1);
	free(tmp_2);
	free(reshape2_9_tmp_0);
	...
	autox_conv2d(split_7_tmp_1, weights + 25760, weights + 25800, relu_20_tmp_0, split_7_tmp_1_dim, conv2d_31_w_0_dim, relu_20_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_7_tmp_1);

	float* batch_norm_32_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(relu_20_tmp_0, weights + 27400, weights + 27440, batch_norm_32_tmp_2, relu_20_tmp_0_dim, conv2d_32_w_0_dim, batch_norm_32_tmp_2_dim, 40, 1, 1, 1, 0);
	free(relu_20_tmp_0);

	float* relu_21_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_32_tmp_2, weights + 27800, weights + 27840, relu_21_tmp_0, batch_norm_32_tmp_2_dim, conv2d_33_w_0_dim, relu_21_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_14_tmp_0, transpose_7_tmp_0, reshape2_14_tmp_0_dim, transpose_7_tmp_0_dim, axis_63, 5);
	...
	autox_split(reshape2_15_tmp_0, p_64, reshape2_15_tmp_0_dim, p_64_dim, 1, 4, 2, 4);
	free(reshape2_15_tmp_0);

	float* relu_22_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(split_8_tmp_1, weights + 29440, weights + 29480, relu_22_tmp_0, split_8_tmp_1_dim, conv2d_34_w_0_dim, relu_22_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_8_tmp_1);

	float* batch_norm_35_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(relu_22_tmp_0, weights + 31080, weights + 31120, batch_norm_35_tmp_2, relu_22_tmp_0_dim, conv2d_35_w_0_dim, batch_norm_35_tmp_2_dim, 40, 1, 1, 1, 0);
	free(relu_22_tmp_0);

	float* relu_23_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_35_tmp_2, weights + 31480, weights + 31520, relu_23_tmp_0, batch_norm_35_tmp_2_dim, conv2d_36_w_0_dim, relu_23_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_16_tmp_0, transpose_8_tmp_0, reshape2_16_tmp_0_dim, transpose_8_tmp_0_dim, axis_69, 5);
	free(reshape2_16_tmp_0);

	float* tmp_4 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(reshape2_13_tmp_0, reshape2_13_tmp_0, tmp_4, reshape2_13_tmp_0_dim, reshape2_13_tmp_0_dim, tmp_4_dim, -1, 4, 4);
	free(reshape2_13_tmp_0);
	free(reshape2_13_tmp_0);

	float* batch_norm_37_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(reshape2_17_tmp_0, weights + 33120, weights + 33160, batch_norm_37_tmp_2, reshape2_17_tmp_0_dim, conv2d_37_w_0_dim, batch_norm_37_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_17_tmp_0);

	float* nearest_interp_v2_1_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_nearest_interp_v2(batch_norm_37_tmp_2, nearest_interp_v2_1_tmp_0, batch_norm_37_tmp_2_dim, nearest_interp_v2_1_tmp_0_dim);
	free(batch_norm_37_tmp_2);

	float* tmp_5 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(tmp_4, nearest_interp_v2_1_tmp_0, tmp_5, tmp_4_dim, nearest_interp_v2_1_tmp_0_dim, tmp_5_dim, -1, 4, 4);
	free(tmp_4);
	free(nearest_interp_v2_1_tmp_0);

	float* relu_24_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_relu(tmp_5, relu_24_tmp_0, tmp_5_dim, relu_24_tmp_0_dim);
	free(tmp_5);

	float* batch_norm_38_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(tmp_5, weights + 36360, weights + 36400, batch_norm_38_tmp_2, tmp_5_dim, conv2d_38_w_0_dim, batch_norm_38_tmp_2_dim, 40, 1, 2, 1, 0);
	free(tmp_5);

	float* batch_norm_39_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_38_tmp_2, weights + 36760, weights + 36840, batch_norm_39_tmp_2, batch_norm_38_tmp_2_dim, conv2d_39_w_0_dim, batch_norm_39_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_38_tmp_2);

	float* tmp_6 = (float*)calloc(15360, sizeof(float));
	autox_elementwise_add(batch_norm_39_tmp_2, batch_norm_39_tmp_2, tmp_6, batch_norm_39_tmp_2_dim, batch_norm_39_tmp_2_dim, tmp_6_dim, -1, 4, 4);
	free(batch_norm_39_tmp_2);
	free(batch_norm_39_tmp_2);

	float* relu_25_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_fusion_elementwise_add_activation(tmp_6, reshape2_17_tmp_0, relu_25_tmp_0, tmp_6_dim, reshape2_17_tmp_0_dim, relu_25_tmp_0_dim, "relu", -1);
	free(tmp_6);
	free(reshape2_17_tmp_0);

	float* batch_norm_40_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(relu_25_tmp_0, weights + 40040, weights + 40120, batch_norm_40_tmp_2, relu_25_tmp_0_dim, conv2d_40_w_0_dim, batch_norm_40_tmp_2_dim, 80, 1, 2, 1, 0);
	free(relu_25_tmp_0);
	...
	autox_conv2d(split_9_tmp_1, weights + 40840, weights + 40860, relu_27_tmp_0, split_9_tmp_1_dim, conv2d_42_w_0_dim, relu_27_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_9_tmp_1);

	float* batch_norm_43_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(relu_27_tmp_0, weights + 41260, weights + 41280, batch_norm_43_tmp_2, relu_27_tmp_0_dim, conv2d_43_w_0_dim, batch_norm_43_tmp_2_dim, 20, 1, 1, 1, 0);
	free(relu_27_tmp_0);

	float* relu_28_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_43_tmp_2, weights + 41460, weights + 41480, relu_28_tmp_0, batch_norm_43_tmp_2_dim, conv2d_44_w_0_dim, relu_28_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_18_tmp_0, transpose_9_tmp_0, reshape2_18_tmp_0_dim, transpose_9_tmp_0_dim, axis_85, 5);
	...
	autox_split(reshape2_19_tmp_0, p_86, reshape2_19_tmp_0_dim, p_86_dim, 1, 4, 2, 4);
	free(reshape2_19_tmp_0);

	float* relu_29_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(split_10_tmp_1, weights + 41880, weights + 41900, relu_29_tmp_0, split_10_tmp_1_dim, conv2d_45_w_0_dim, relu_29_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_10_tmp_1);

	float* batch_norm_46_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(relu_29_tmp_0, weights + 42300, weights + 42320, batch_norm_46_tmp_2, relu_29_tmp_0_dim, conv2d_46_w_0_dim, batch_norm_46_tmp_2_dim, 20, 1, 1, 1, 0);
	free(relu_29_tmp_0);

	float* relu_30_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_46_tmp_2, weights + 42500, weights + 42520, relu_30_tmp_0, batch_norm_46_tmp_2_dim, conv2d_47_w_0_dim, relu_30_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_20_tmp_0, transpose_10_tmp_0, reshape2_20_tmp_0_dim, transpose_10_tmp_0_dim, axis_91, 5);
	...
	autox_conv2d(split_11_tmp_1, weights + 42920, weights + 42960, relu_31_tmp_0, split_11_tmp_1_dim, conv2d_48_w_0_dim, relu_31_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_11_tmp_1);

	float* batch_norm_49_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(relu_31_tmp_0, weights + 44560, weights + 44600, batch_norm_49_tmp_2, relu_31_tmp_0_dim, conv2d_49_w_0_dim, batch_norm_49_tmp_2_dim, 40, 1, 1, 1, 0);
	free(relu_31_tmp_0);

	float* relu_32_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_49_tmp_2, weights + 44960, weights + 45000, relu_32_tmp_0, batch_norm_49_tmp_2_dim, conv2d_50_w_0_dim, relu_32_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_22_tmp_0, transpose_11_tmp_0, reshape2_22_tmp_0_dim, transpose_11_tmp_0_dim, axis_97, 5);
	...
	autox_split(reshape2_23_tmp_0, p_98, reshape2_23_tmp_0_dim, p_98_dim, 1, 4, 2, 4);
	free(reshape2_23_tmp_0);

	float* relu_33_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(split_12_tmp_1, weights + 46600, weights + 46640, relu_33_tmp_0, split_12_tmp_1_dim, conv2d_51_w_0_dim, relu_33_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_12_tmp_1);

	float* batch_norm_52_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(relu_33_tmp_0, weights + 48240, weights + 48280, batch_norm_52_tmp_2, relu_33_tmp_0_dim, conv2d_52_w_0_dim, batch_norm_52_tmp_2_dim, 40, 1, 1, 1, 0);
	free(relu_33_tmp_0);

	float* relu_34_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_52_tmp_2, weights + 48640, weights + 48680, relu_34_tmp_0, batch_norm_52_tmp_2_dim, conv2d_53_w_0_dim, relu_34_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_24_tmp_0, transpose_12_tmp_0, reshape2_24_tmp_0_dim, transpose_12_tmp_0_dim, axis_103, 5);
	free(reshape2_24_tmp_0);

	float* relu_26_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_40_tmp_2, weights + 50280, weights + 50440, relu_26_tmp_0, batch_norm_40_tmp_2_dim, conv2d_41_w_0_dim, relu_26_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_conv2d(split_13_tmp_1, weights + 63240, weights + 63320, relu_35_tmp_0, split_13_tmp_1_dim, conv2d_54_w_0_dim, relu_35_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_13_tmp_1);

	float* batch_norm_55_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(relu_35_tmp_0, weights + 69720, weights + 69800, batch_norm_55_tmp_2, relu_35_tmp_0_dim, conv2d_55_w_0_dim, batch_norm_55_tmp_2_dim, 80, 1, 1, 1, 0);
	free(relu_35_tmp_0);

	float* relu_36_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_55_tmp_2, weights + 70520, weights + 70600, relu_36_tmp_0, batch_norm_55_tmp_2_dim, conv2d_56_w_0_dim, relu_36_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_26_tmp_0, transpose_13_tmp_0, reshape2_26_tmp_0_dim, transpose_13_tmp_0_dim, axis_110, 5);
	...
	autox_split(reshape2_27_tmp_0, p_111, reshape2_27_tmp_0_dim, p_111_dim, 1, 4, 2, 4);
	free(reshape2_27_tmp_0);

	float* relu_37_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(split_14_tmp_1, weights + 77000, weights + 77080, relu_37_tmp_0, split_14_tmp_1_dim, conv2d_57_w_0_dim, relu_37_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_14_tmp_1);

	float* batch_norm_58_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(relu_37_tmp_0, weights + 83480, weights + 83560, batch_norm_58_tmp_2, relu_37_tmp_0_dim, conv2d_58_w_0_dim, batch_norm_58_tmp_2_dim, 80, 1, 1, 1, 0);
	free(relu_37_tmp_0);

	float* relu_38_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_58_tmp_2, weights + 84280, weights + 84360, relu_38_tmp_0, batch_norm_58_tmp_2_dim, conv2d_59_w_0_dim, relu_38_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_28_tmp_0, transpose_14_tmp_0, reshape2_28_tmp_0_dim, transpose_14_tmp_0_dim, axis_116, 5);
	free(reshape2_28_tmp_0);

	float* tmp_8 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(reshape2_21_tmp_0, reshape2_21_tmp_0, tmp_8, reshape2_21_tmp_0_dim, reshape2_21_tmp_0_dim, tmp_8_dim, -1, 4, 4);
	free(reshape2_21_tmp_0);
	free(reshape2_21_tmp_0);

	float* batch_norm_60_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(reshape2_25_tmp_0, weights + 90760, weights + 90800, batch_norm_60_tmp_2, reshape2_25_tmp_0_dim, conv2d_60_w_0_dim, batch_norm_60_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_25_tmp_0);

	float* nearest_interp_v2_2_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_nearest_interp_v2(batch_norm_60_tmp_2, nearest_interp_v2_2_tmp_0, batch_norm_60_tmp_2_dim, nearest_interp_v2_2_tmp_0_dim);
	free(batch_norm_60_tmp_2);

	float* tmp_9 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(tmp_8, nearest_interp_v2_2_tmp_0, tmp_9, tmp_8_dim, nearest_interp_v2_2_tmp_0_dim, tmp_9_dim, -1, 4, 4);
	free(tmp_8);
	free(nearest_interp_v2_2_tmp_0);

	float* batch_norm_61_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(reshape2_29_tmp_0, weights + 94000, weights + 94040, batch_norm_61_tmp_2, reshape2_29_tmp_0_dim, conv2d_61_w_0_dim, batch_norm_61_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_29_tmp_0);

	float* nearest_interp_v2_3_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_nearest_interp_v2(batch_norm_61_tmp_2, nearest_interp_v2_3_tmp_0, batch_norm_61_tmp_2_dim, nearest_interp_v2_3_tmp_0_dim);
	free(batch_norm_61_tmp_2);

	float* tmp_10 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(tmp_9, nearest_interp_v2_3_tmp_0, tmp_10, tmp_9_dim, nearest_interp_v2_3_tmp_0_dim, tmp_10_dim, -1, 4, 4);
	free(tmp_9);
	free(nearest_interp_v2_3_tmp_0);

	float* relu_39_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_relu(tmp_10, relu_39_tmp_0, tmp_10_dim, relu_39_tmp_0_dim);
	free(tmp_10);

	float* batch_norm_62_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(tmp_10, weights + 100440, weights + 100480, batch_norm_62_tmp_2, tmp_10_dim, conv2d_62_w_0_dim, batch_norm_62_tmp_2_dim, 40, 1, 2, 1, 0);
	free(tmp_10);

	float* batch_norm_63_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_62_tmp_2, weights + 100840, weights + 100920, batch_norm_63_tmp_2, batch_norm_62_tmp_2_dim, conv2d_63_w_0_dim, batch_norm_63_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_62_tmp_2);

	float* tmp_11 = (float*)calloc(15360, sizeof(float));
	autox_elementwise_add(batch_norm_63_tmp_2, batch_norm_63_tmp_2, tmp_11, batch_norm_63_tmp_2_dim, batch_norm_63_tmp_2_dim, tmp_11_dim, -1, 4, 4);
	free(batch_norm_63_tmp_2);
	free(batch_norm_63_tmp_2);

	float* tmp_12 = (float*)calloc(15360, sizeof(float));
	autox_elementwise_add(tmp_11, reshape2_25_tmp_0, tmp_12, tmp_11_dim, reshape2_25_tmp_0_dim, tmp_12_dim, -1, 4, 4);
	free(tmp_11);
	free(reshape2_25_tmp_0);

	float* batch_norm_64_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(reshape2_29_tmp_0, weights + 104120, weights + 104200, batch_norm_64_tmp_2, reshape2_29_tmp_0_dim, conv2d_64_w_0_dim, batch_norm_64_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_29_tmp_0);

	float* nearest_interp_v2_4_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_nearest_interp_v2(batch_norm_64_tmp_2, nearest_interp_v2_4_tmp_0, batch_norm_64_tmp_2_dim, nearest_interp_v2_4_tmp_0_dim);
	free(batch_norm_64_tmp_2);

	float* batch_norm_65_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(tmp_10, weights + 117000, weights + 117040, batch_norm_65_tmp_2, tmp_10_dim, conv2d_65_w_0_dim, batch_norm_65_tmp_2_dim, 40, 1, 2, 1, 0);
	free(tmp_10);

	float* relu_41_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_65_tmp_2, weights + 117400, weights + 117440, relu_41_tmp_0, batch_norm_65_tmp_2_dim, conv2d_66_w_0_dim, relu_41_tmp_0_dim, 1, 0, 1, 1, 1);
	free(batch_norm_65_tmp_2);

	float* batch_norm_67_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(relu_41_tmp_0, weights + 119040, weights + 119080, batch_norm_67_tmp_2, relu_41_tmp_0_dim, conv2d_67_w_0_dim, batch_norm_67_tmp_2_dim, 40, 1, 2, 1, 0);
	free(relu_41_tmp_0);

	float* batch_norm_68_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_67_tmp_2, weights + 119440, weights + 119600, batch_norm_68_tmp_2, batch_norm_67_tmp_2_dim, conv2d_68_w_0_dim, batch_norm_68_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_67_tmp_2);

	float* tmp_14 = (float*)calloc(7680, sizeof(float));
	autox_elementwise_add(batch_norm_68_tmp_2, batch_norm_68_tmp_2, tmp_14, batch_norm_68_tmp_2_dim, batch_norm_68_tmp_2_dim, tmp_14_dim, -1, 4, 4);
	free(batch_norm_68_tmp_2);
	free(batch_norm_68_tmp_2);

	float* batch_norm_69_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(reshape2_25_tmp_0, weights + 126000, weights + 126080, batch_norm_69_tmp_2, reshape2_25_tmp_0_dim, conv2d_69_w_0_dim, batch_norm_69_tmp_2_dim, 80, 1, 2, 1, 0);
	free(reshape2_25_tmp_0);

	float* batch_norm_70_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_69_tmp_2, weights + 126800, weights + 126960, batch_norm_70_tmp_2, batch_norm_69_tmp_2_dim, conv2d_70_w_0_dim, batch_norm_70_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_69_tmp_2);

	float* tmp_15 = (float*)calloc(7680, sizeof(float));
	autox_elementwise_add(tmp_14, batch_norm_70_tmp_2, tmp_15, tmp_14_dim, batch_norm_70_tmp_2_dim, tmp_15_dim, -1, 4, 4);
	free(tmp_14);
	...
	autox_conv2d(split_15_tmp_1, weights + 139760, weights + 139780, relu_43_tmp_0, split_15_tmp_1_dim, conv2d_71_w_0_dim, relu_43_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_15_tmp_1);

	float* batch_norm_72_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(relu_43_tmp_0, weights + 140180, weights + 140200, batch_norm_72_tmp_2, relu_43_tmp_0_dim, conv2d_72_w_0_dim, batch_norm_72_tmp_2_dim, 20, 1, 1, 1, 0);
	free(relu_43_tmp_0);

	float* relu_44_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_72_tmp_2, weights + 140380, weights + 140400, relu_44_tmp_0, batch_norm_72_tmp_2_dim, conv2d_73_w_0_dim, relu_44_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_30_tmp_0, transpose_15_tmp_0, reshape2_30_tmp_0_dim, transpose_15_tmp_0_dim, axis_144, 5);
	...
	autox_split(reshape2_31_tmp_0, p_145, reshape2_31_tmp_0_dim, p_145_dim, 1, 4, 2, 4);
	free(reshape2_31_tmp_0);

	float* relu_45_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(split_16_tmp_1, weights + 140800, weights + 140820, relu_45_tmp_0, split_16_tmp_1_dim, conv2d_74_w_0_dim, relu_45_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_16_tmp_1);

	float* batch_norm_75_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(relu_45_tmp_0, weights + 141220, weights + 141240, batch_norm_75_tmp_2, relu_45_tmp_0_dim, conv2d_75_w_0_dim, batch_norm_75_tmp_2_dim, 20, 1, 1, 1, 0);
	free(relu_45_tmp_0);

	float* relu_46_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_75_tmp_2, weights + 141420, weights + 141440, relu_46_tmp_0, batch_norm_75_tmp_2_dim, conv2d_76_w_0_dim, relu_46_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_32_tmp_0, transpose_16_tmp_0, reshape2_32_tmp_0_dim, transpose_16_tmp_0_dim, axis_150, 5);
	free(reshape2_32_tmp_0);

	float* relu_40_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_fusion_elementwise_add_activation(tmp_12, nearest_interp_v2_4_tmp_0, relu_40_tmp_0, tmp_12_dim, nearest_interp_v2_4_tmp_0_dim, relu_40_tmp_0_dim, "relu", -1);
	free(tmp_12);
	...
	autox_conv2d(split_17_tmp_1, weights + 141840, weights + 141880, relu_47_tmp_0, split_17_tmp_1_dim, conv2d_77_w_0_dim, relu_47_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_17_tmp_1);

	float* batch_norm_78_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(relu_47_tmp_0, weights + 143480, weights + 143520, batch_norm_78_tmp_2, relu_47_tmp_0_dim, conv2d_78_w_0_dim, batch_norm_78_tmp_2_dim, 40, 1, 1, 1, 0);
	free(relu_47_tmp_0);

	float* relu_48_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_78_tmp_2, weights + 143880, weights + 143920, relu_48_tmp_0, batch_norm_78_tmp_2_dim, conv2d_79_w_0_dim, relu_48_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_34_tmp_0, transpose_17_tmp_0, reshape2_34_tmp_0_dim, transpose_17_tmp_0_dim, axis_157, 5);
	free(reshape2_34_tmp_0);
	...
	autox_split(reshape2_35_tmp_0, p_158, reshape2_35_tmp_0_dim, p_158_dim, 1, 4, 2, 4);
	free(reshape2_35_tmp_0);

	float* relu_49_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(split_18_tmp_1, weights + 145520, weights + 145560, relu_49_tmp_0, split_18_tmp_1_dim, conv2d_80_w_0_dim, relu_49_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_18_tmp_1);

	float* batch_norm_81_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(relu_49_tmp_0, weights + 147160, weights + 147200, batch_norm_81_tmp_2, relu_49_tmp_0_dim, conv2d_81_w_0_dim, batch_norm_81_tmp_2_dim, 40, 1, 1, 1, 0);
	free(relu_49_tmp_0);

	float* relu_50_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_81_tmp_2, weights + 147560, weights + 147600, relu_50_tmp_0, batch_norm_81_tmp_2_dim, conv2d_82_w_0_dim, relu_50_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_36_tmp_0, transpose_18_tmp_0, reshape2_36_tmp_0_dim, transpose_18_tmp_0_dim, axis_163, 5);
	free(reshape2_36_tmp_0);

	float* relu_42_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_fusion_elementwise_add_activation(tmp_15, reshape2_29_tmp_0, relu_42_tmp_0, tmp_15_dim, reshape2_29_tmp_0_dim, relu_42_tmp_0_dim, "relu", -1);
	free(tmp_15);
	free(reshape2_29_tmp_0);
	...
	autox_conv2d(split_19_tmp_1, weights + 149200, weights + 149280, relu_51_tmp_0, split_19_tmp_1_dim, conv2d_83_w_0_dim, relu_51_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_19_tmp_1);

	float* batch_norm_84_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(relu_51_tmp_0, weights + 155680, weights + 155760, batch_norm_84_tmp_2, relu_51_tmp_0_dim, conv2d_84_w_0_dim, batch_norm_84_tmp_2_dim, 80, 1, 1, 1, 0);
	free(relu_51_tmp_0);

	float* relu_52_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_84_tmp_2, weights + 156480, weights + 156560, relu_52_tmp_0, batch_norm_84_tmp_2_dim, conv2d_85_w_0_dim, relu_52_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_38_tmp_0, transpose_19_tmp_0, reshape2_38_tmp_0_dim, transpose_19_tmp_0_dim, axis_170, 5);
	free(reshape2_38_tmp_0);
	...
	autox_split(reshape2_39_tmp_0, p_171, reshape2_39_tmp_0_dim, p_171_dim, 1, 4, 2, 4);
	free(reshape2_39_tmp_0);

	float* relu_53_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(split_20_tmp_1, weights + 162960, weights + 163040, relu_53_tmp_0, split_20_tmp_1_dim, conv2d_86_w_0_dim, relu_53_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_20_tmp_1);

	float* batch_norm_87_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(relu_53_tmp_0, weights + 169440, weights + 169520, batch_norm_87_tmp_2, relu_53_tmp_0_dim, conv2d_87_w_0_dim, batch_norm_87_tmp_2_dim, 80, 1, 1, 1, 0);
	free(relu_53_tmp_0);

	float* relu_54_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_87_tmp_2, weights + 170240, weights + 170320, relu_54_tmp_0, batch_norm_87_tmp_2_dim, conv2d_88_w_0_dim, relu_54_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_40_tmp_0, transpose_20_tmp_0, reshape2_40_tmp_0_dim, transpose_20_tmp_0_dim, axis_176, 5);
	free(reshape2_40_tmp_0);

	float* tmp_17 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(reshape2_33_tmp_0, reshape2_33_tmp_0, tmp_17, reshape2_33_tmp_0_dim, reshape2_33_tmp_0_dim, tmp_17_dim, -1, 4, 4);
	free(reshape2_33_tmp_0);
	free(reshape2_33_tmp_0);

	float* batch_norm_89_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(reshape2_37_tmp_0, weights + 176720, weights + 176760, batch_norm_89_tmp_2, reshape2_37_tmp_0_dim, conv2d_89_w_0_dim, batch_norm_89_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_37_tmp_0);

	float* nearest_interp_v2_5_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_nearest_interp_v2(batch_norm_89_tmp_2, nearest_interp_v2_5_tmp_0, batch_norm_89_tmp_2_dim, nearest_interp_v2_5_tmp_0_dim);
	free(batch_norm_89_tmp_2);

	float* tmp_18 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(tmp_17, nearest_interp_v2_5_tmp_0, tmp_18, tmp_17_dim, nearest_interp_v2_5_tmp_0_dim, tmp_18_dim, -1, 4, 4);
	free(tmp_17);
	free(nearest_interp_v2_5_tmp_0);

	float* batch_norm_90_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(reshape2_41_tmp_0, weights + 179960, weights + 180000, batch_norm_90_tmp_2, reshape2_41_tmp_0_dim, conv2d_90_w_0_dim, batch_norm_90_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_41_tmp_0);

	float* nearest_interp_v2_6_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_nearest_interp_v2(batch_norm_90_tmp_2, nearest_interp_v2_6_tmp_0, batch_norm_90_tmp_2_dim, nearest_interp_v2_6_tmp_0_dim);
	free(batch_norm_90_tmp_2);

	float* tmp_19 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(tmp_18, nearest_interp_v2_6_tmp_0, tmp_19, tmp_18_dim, nearest_interp_v2_6_tmp_0_dim, tmp_19_dim, -1, 4, 4);
	free(tmp_18);
	free(nearest_interp_v2_6_tmp_0);

	float* relu_55_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_relu(tmp_19, relu_55_tmp_0, tmp_19_dim, relu_55_tmp_0_dim);
	free(tmp_19);

	float* batch_norm_91_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(tmp_19, weights + 186400, weights + 186440, batch_norm_91_tmp_2, tmp_19_dim, conv2d_91_w_0_dim, batch_norm_91_tmp_2_dim, 40, 1, 2, 1, 0);
	free(tmp_19);

	float* batch_norm_92_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_91_tmp_2, weights + 186800, weights + 186880, batch_norm_92_tmp_2, batch_norm_91_tmp_2_dim, conv2d_92_w_0_dim, batch_norm_92_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_91_tmp_2);

	float* tmp_20 = (float*)calloc(15360, sizeof(float));
	autox_elementwise_add(batch_norm_92_tmp_2, batch_norm_92_tmp_2, tmp_20, batch_norm_92_tmp_2_dim, batch_norm_92_tmp_2_dim, tmp_20_dim, -1, 4, 4);
	free(batch_norm_92_tmp_2);
	free(batch_norm_92_tmp_2);

	float* tmp_21 = (float*)calloc(15360, sizeof(float));
	autox_elementwise_add(tmp_20, reshape2_37_tmp_0, tmp_21, tmp_20_dim, reshape2_37_tmp_0_dim, tmp_21_dim, -1, 4, 4);
	free(tmp_20);
	free(reshape2_37_tmp_0);

	float* batch_norm_93_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(reshape2_41_tmp_0, weights + 190080, weights + 190160, batch_norm_93_tmp_2, reshape2_41_tmp_0_dim, conv2d_93_w_0_dim, batch_norm_93_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_41_tmp_0);

	float* nearest_interp_v2_7_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_nearest_interp_v2(batch_norm_93_tmp_2, nearest_interp_v2_7_tmp_0, batch_norm_93_tmp_2_dim, nearest_interp_v2_7_tmp_0_dim);
	free(batch_norm_93_tmp_2);

	float* batch_norm_94_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(tmp_19, weights + 202960, weights + 203000, batch_norm_94_tmp_2, tmp_19_dim, conv2d_94_w_0_dim, batch_norm_94_tmp_2_dim, 40, 1, 2, 1, 0);
	free(tmp_19);

	float* relu_57_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_94_tmp_2, weights + 203360, weights + 203400, relu_57_tmp_0, batch_norm_94_tmp_2_dim, conv2d_95_w_0_dim, relu_57_tmp_0_dim, 1, 0, 1, 1, 1);
	free(batch_norm_94_tmp_2);

	float* batch_norm_96_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(relu_57_tmp_0, weights + 205000, weights + 205040, batch_norm_96_tmp_2, relu_57_tmp_0_dim, conv2d_96_w_0_dim, batch_norm_96_tmp_2_dim, 40, 1, 2, 1, 0);
	free(relu_57_tmp_0);

	float* batch_norm_97_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_96_tmp_2, weights + 205400, weights + 205560, batch_norm_97_tmp_2, batch_norm_96_tmp_2_dim, conv2d_97_w_0_dim, batch_norm_97_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_96_tmp_2);

	float* tmp_23 = (float*)calloc(7680, sizeof(float));
	autox_elementwise_add(batch_norm_97_tmp_2, batch_norm_97_tmp_2, tmp_23, batch_norm_97_tmp_2_dim, batch_norm_97_tmp_2_dim, tmp_23_dim, -1, 4, 4);
	free(batch_norm_97_tmp_2);
	free(batch_norm_97_tmp_2);

	float* batch_norm_98_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(reshape2_37_tmp_0, weights + 211960, weights + 212040, batch_norm_98_tmp_2, reshape2_37_tmp_0_dim, conv2d_98_w_0_dim, batch_norm_98_tmp_2_dim, 80, 1, 2, 1, 0);
	free(reshape2_37_tmp_0);

	float* batch_norm_99_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_98_tmp_2, weights + 212760, weights + 212920, batch_norm_99_tmp_2, batch_norm_98_tmp_2_dim, conv2d_99_w_0_dim, batch_norm_99_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_98_tmp_2);

	float* tmp_24 = (float*)calloc(7680, sizeof(float));
	autox_elementwise_add(tmp_23, batch_norm_99_tmp_2, tmp_24, tmp_23_dim, batch_norm_99_tmp_2_dim, tmp_24_dim, -1, 4, 4);
	free(tmp_23);
	...
	autox_conv2d(split_21_tmp_1, weights + 225720, weights + 225740, relu_59_tmp_0, split_21_tmp_1_dim, conv2d_100_w_0_dim, relu_59_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_21_tmp_1);

	float* batch_norm_101_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(relu_59_tmp_0, weights + 226140, weights + 226160, batch_norm_101_tmp_2, relu_59_tmp_0_dim, conv2d_101_w_0_dim, batch_norm_101_tmp_2_dim, 20, 1, 1, 1, 0);
	free(relu_59_tmp_0);

	float* relu_60_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_101_tmp_2, weights + 226340, weights + 226360, relu_60_tmp_0, batch_norm_101_tmp_2_dim, conv2d_102_w_0_dim, relu_60_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_42_tmp_0, transpose_21_tmp_0, reshape2_42_tmp_0_dim, transpose_21_tmp_0_dim, axis_204, 5);
	free(reshape2_42_tmp_0);
	...
	autox_split(reshape2_43_tmp_0, p_205, reshape2_43_tmp_0_dim, p_205_dim, 1, 4, 2, 4);
	free(reshape2_43_tmp_0);

	float* relu_61_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(split_22_tmp_1, weights + 226760, weights + 226780, relu_61_tmp_0, split_22_tmp_1_dim, conv2d_103_w_0_dim, relu_61_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_22_tmp_1);

	float* batch_norm_104_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(relu_61_tmp_0, weights + 227180, weights + 227200, batch_norm_104_tmp_2, relu_61_tmp_0_dim, conv2d_104_w_0_dim, batch_norm_104_tmp_2_dim, 20, 1, 1, 1, 0);
	free(relu_61_tmp_0);

	float* relu_62_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_104_tmp_2, weights + 227380, weights + 227400, relu_62_tmp_0, batch_norm_104_tmp_2_dim, conv2d_105_w_0_dim, relu_62_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_44_tmp_0, transpose_22_tmp_0, reshape2_44_tmp_0_dim, transpose_22_tmp_0_dim, axis_210, 5);
	free(reshape2_44_tmp_0);

	float* relu_56_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_fusion_elementwise_add_activation(tmp_21, nearest_interp_v2_7_tmp_0, relu_56_tmp_0, tmp_21_dim, nearest_interp_v2_7_tmp_0_dim, relu_56_tmp_0_dim, "relu", -1);
	free(tmp_21);
	...
	autox_conv2d(split_23_tmp_1, weights + 227800, weights + 227840, relu_63_tmp_0, split_23_tmp_1_dim, conv2d_106_w_0_dim, relu_63_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_23_tmp_1);

	float* batch_norm_107_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(relu_63_tmp_0, weights + 229440, weights + 229480, batch_norm_107_tmp_2, relu_63_tmp_0_dim, conv2d_107_w_0_dim, batch_norm_107_tmp_2_dim, 40, 1, 1, 1, 0);
	free(relu_63_tmp_0);

	float* relu_64_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_107_tmp_2, weights + 229840, weights + 229880, relu_64_tmp_0, batch_norm_107_tmp_2_dim, conv2d_108_w_0_dim, relu_64_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_46_tmp_0, transpose_23_tmp_0, reshape2_46_tmp_0_dim, transpose_23_tmp_0_dim, axis_217, 5);
	free(reshape2_46_tmp_0);
	...
	autox_split(reshape2_47_tmp_0, p_218, reshape2_47_tmp_0_dim, p_218_dim, 1, 4, 2, 4);
	free(reshape2_47_tmp_0);

	float* relu_65_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(split_24_tmp_1, weights + 231480, weights + 231520, relu_65_tmp_0, split_24_tmp_1_dim, conv2d_109_w_0_dim, relu_65_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_24_tmp_1);

	float* batch_norm_110_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(relu_65_tmp_0, weights + 233120, weights + 233160, batch_norm_110_tmp_2, relu_65_tmp_0_dim, conv2d_110_w_0_dim, batch_norm_110_tmp_2_dim, 40, 1, 1, 1, 0);
	free(relu_65_tmp_0);

	float* relu_66_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_110_tmp_2, weights + 233520, weights + 233560, relu_66_tmp_0, batch_norm_110_tmp_2_dim, conv2d_111_w_0_dim, relu_66_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_48_tmp_0, transpose_24_tmp_0, reshape2_48_tmp_0_dim, transpose_24_tmp_0_dim, axis_223, 5);
	free(reshape2_48_tmp_0);

	float* relu_58_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_fusion_elementwise_add_activation(tmp_24, reshape2_41_tmp_0, relu_58_tmp_0, tmp_24_dim, reshape2_41_tmp_0_dim, relu_58_tmp_0_dim, "relu", -1);
	free(tmp_24);
	free(reshape2_41_tmp_0);
	...
	autox_conv2d(split_25_tmp_1, weights + 235160, weights + 235240, relu_67_tmp_0, split_25_tmp_1_dim, conv2d_112_w_0_dim, relu_67_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_25_tmp_1);

	float* batch_norm_113_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(relu_67_tmp_0, weights + 241640, weights + 241720, batch_norm_113_tmp_2, relu_67_tmp_0_dim, conv2d_113_w_0_dim, batch_norm_113_tmp_2_dim, 80, 1, 1, 1, 0);
	free(relu_67_tmp_0);

	float* relu_68_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_113_tmp_2, weights + 242440, weights + 242520, relu_68_tmp_0, batch_norm_113_tmp_2_dim, conv2d_114_w_0_dim, relu_68_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_50_tmp_0, transpose_25_tmp_0, reshape2_50_tmp_0_dim, transpose_25_tmp_0_dim, axis_230, 5);
	free(reshape2_50_tmp_0);
	...
	autox_split(reshape2_51_tmp_0, p_231, reshape2_51_tmp_0_dim, p_231_dim, 1, 4, 2, 4);
	free(reshape2_51_tmp_0);

	float* relu_69_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(split_26_tmp_1, weights + 248920, weights + 249000, relu_69_tmp_0, split_26_tmp_1_dim, conv2d_115_w_0_dim, relu_69_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_26_tmp_1);

	float* batch_norm_116_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(relu_69_tmp_0, weights + 255400, weights + 255480, batch_norm_116_tmp_2, relu_69_tmp_0_dim, conv2d_116_w_0_dim, batch_norm_116_tmp_2_dim, 80, 1, 1, 1, 0);
	free(relu_69_tmp_0);

	float* relu_70_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_116_tmp_2, weights + 256200, weights + 256280, relu_70_tmp_0, batch_norm_116_tmp_2_dim, conv2d_117_w_0_dim, relu_70_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_52_tmp_0, transpose_26_tmp_0, reshape2_52_tmp_0_dim, transpose_26_tmp_0_dim, axis_236, 5);
	free(reshape2_52_tmp_0);

	float* tmp_26 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(reshape2_45_tmp_0, reshape2_45_tmp_0, tmp_26, reshape2_45_tmp_0_dim, reshape2_45_tmp_0_dim, tmp_26_dim, -1, 4, 4);
	free(reshape2_45_tmp_0);
	free(reshape2_45_tmp_0);

	float* batch_norm_118_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(reshape2_49_tmp_0, weights + 262680, weights + 262720, batch_norm_118_tmp_2, reshape2_49_tmp_0_dim, conv2d_118_w_0_dim, batch_norm_118_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_49_tmp_0);

	float* nearest_interp_v2_8_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_nearest_interp_v2(batch_norm_118_tmp_2, nearest_interp_v2_8_tmp_0, batch_norm_118_tmp_2_dim, nearest_interp_v2_8_tmp_0_dim);
	free(batch_norm_118_tmp_2);

	float* tmp_27 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(tmp_26, nearest_interp_v2_8_tmp_0, tmp_27, tmp_26_dim, nearest_interp_v2_8_tmp_0_dim, tmp_27_dim, -1, 4, 4);
	free(tmp_26);
	free(nearest_interp_v2_8_tmp_0);

	float* batch_norm_119_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(reshape2_53_tmp_0, weights + 265920, weights + 265960, batch_norm_119_tmp_2, reshape2_53_tmp_0_dim, conv2d_119_w_0_dim, batch_norm_119_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_53_tmp_0);

	float* nearest_interp_v2_9_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_nearest_interp_v2(batch_norm_119_tmp_2, nearest_interp_v2_9_tmp_0, batch_norm_119_tmp_2_dim, nearest_interp_v2_9_tmp_0_dim);
	free(batch_norm_119_tmp_2);

	float* tmp_28 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(tmp_27, nearest_interp_v2_9_tmp_0, tmp_28, tmp_27_dim, nearest_interp_v2_9_tmp_0_dim, tmp_28_dim, -1, 4, 4);
	free(tmp_27);
	free(nearest_interp_v2_9_tmp_0);

	float* relu_71_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_relu(tmp_28, relu_71_tmp_0, tmp_28_dim, relu_71_tmp_0_dim);
	free(tmp_28);

	float* batch_norm_120_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(tmp_28, weights + 272360, weights + 272400, batch_norm_120_tmp_2, tmp_28_dim, conv2d_120_w_0_dim, batch_norm_120_tmp_2_dim, 40, 1, 2, 1, 0);
	free(tmp_28);

	float* batch_norm_121_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_120_tmp_2, weights + 272760, weights + 272840, batch_norm_121_tmp_2, batch_norm_120_tmp_2_dim, conv2d_121_w_0_dim, batch_norm_121_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_120_tmp_2);

	float* tmp_29 = (float*)calloc(15360, sizeof(float));
	autox_elementwise_add(batch_norm_121_tmp_2, batch_norm_121_tmp_2, tmp_29, batch_norm_121_tmp_2_dim, batch_norm_121_tmp_2_dim, tmp_29_dim, -1, 4, 4);
	free(batch_norm_121_tmp_2);
	free(batch_norm_121_tmp_2);

	float* tmp_30 = (float*)calloc(15360, sizeof(float));
	autox_elementwise_add(tmp_29, reshape2_49_tmp_0, tmp_30, tmp_29_dim, reshape2_49_tmp_0_dim, tmp_30_dim, -1, 4, 4);
	free(tmp_29);
	free(reshape2_49_tmp_0);

	float* batch_norm_122_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(reshape2_53_tmp_0, weights + 276040, weights + 276120, batch_norm_122_tmp_2, reshape2_53_tmp_0_dim, conv2d_122_w_0_dim, batch_norm_122_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_53_tmp_0);

	float* nearest_interp_v2_10_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_nearest_interp_v2(batch_norm_122_tmp_2, nearest_interp_v2_10_tmp_0, batch_norm_122_tmp_2_dim, nearest_interp_v2_10_tmp_0_dim);
	free(batch_norm_122_tmp_2);

	float* batch_norm_123_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(tmp_28, weights + 288920, weights + 288960, batch_norm_123_tmp_2, tmp_28_dim, conv2d_123_w_0_dim, batch_norm_123_tmp_2_dim, 40, 1, 2, 1, 0);
	free(tmp_28);

	float* relu_73_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_123_tmp_2, weights + 289320, weights + 289360, relu_73_tmp_0, batch_norm_123_tmp_2_dim, conv2d_124_w_0_dim, relu_73_tmp_0_dim, 1, 0, 1, 1, 1);
	free(batch_norm_123_tmp_2);

	float* batch_norm_125_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(relu_73_tmp_0, weights + 290960, weights + 291000, batch_norm_125_tmp_2, relu_73_tmp_0_dim, conv2d_125_w_0_dim, batch_norm_125_tmp_2_dim, 40, 1, 2, 1, 0);
	free(relu_73_tmp_0);

	float* batch_norm_126_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_125_tmp_2, weights + 291360, weights + 291520, batch_norm_126_tmp_2, batch_norm_125_tmp_2_dim, conv2d_126_w_0_dim, batch_norm_126_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_125_tmp_2);

	float* tmp_32 = (float*)calloc(7680, sizeof(float));
	autox_elementwise_add(batch_norm_126_tmp_2, batch_norm_126_tmp_2, tmp_32, batch_norm_126_tmp_2_dim, batch_norm_126_tmp_2_dim, tmp_32_dim, -1, 4, 4);
	free(batch_norm_126_tmp_2);
	free(batch_norm_126_tmp_2);

	float* batch_norm_127_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(reshape2_49_tmp_0, weights + 297920, weights + 298000, batch_norm_127_tmp_2, reshape2_49_tmp_0_dim, conv2d_127_w_0_dim, batch_norm_127_tmp_2_dim, 80, 1, 2, 1, 0);
	free(reshape2_49_tmp_0);

	float* batch_norm_128_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_127_tmp_2, weights + 298720, weights + 298880, batch_norm_128_tmp_2, batch_norm_127_tmp_2_dim, conv2d_128_w_0_dim, batch_norm_128_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_127_tmp_2);

	float* tmp_33 = (float*)calloc(7680, sizeof(float));
	autox_elementwise_add(tmp_32, batch_norm_128_tmp_2, tmp_33, tmp_32_dim, batch_norm_128_tmp_2_dim, tmp_33_dim, -1, 4, 4);
	free(tmp_32);
	...
	autox_conv2d(split_27_tmp_1, weights + 311680, weights + 311700, relu_75_tmp_0, split_27_tmp_1_dim, conv2d_129_w_0_dim, relu_75_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_27_tmp_1);

	float* batch_norm_130_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(relu_75_tmp_0, weights + 312100, weights + 312120, batch_norm_130_tmp_2, relu_75_tmp_0_dim, conv2d_130_w_0_dim, batch_norm_130_tmp_2_dim, 20, 1, 1, 1, 0);
	free(relu_75_tmp_0);

	float* relu_76_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_130_tmp_2, weights + 312300, weights + 312320, relu_76_tmp_0, batch_norm_130_tmp_2_dim, conv2d_131_w_0_dim, relu_76_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_54_tmp_0, transpose_27_tmp_0, reshape2_54_tmp_0_dim, transpose_27_tmp_0_dim, axis_264, 5);
	free(reshape2_54_tmp_0);
	...
	autox_split(reshape2_55_tmp_0, p_265, reshape2_55_tmp_0_dim, p_265_dim, 1, 4, 2, 4);
	free(reshape2_55_tmp_0);

	float* relu_77_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(split_28_tmp_1, weights + 312720, weights + 312740, relu_77_tmp_0, split_28_tmp_1_dim, conv2d_132_w_0_dim, relu_77_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_28_tmp_1);

	float* batch_norm_133_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(relu_77_tmp_0, weights + 313140, weights + 313160, batch_norm_133_tmp_2, relu_77_tmp_0_dim, conv2d_133_w_0_dim, batch_norm_133_tmp_2_dim, 20, 1, 1, 1, 0);
	free(relu_77_tmp_0);

	float* relu_78_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_133_tmp_2, weights + 313340, weights + 313360, relu_78_tmp_0, batch_norm_133_tmp_2_dim, conv2d_134_w_0_dim, relu_78_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_56_tmp_0, transpose_28_tmp_0, reshape2_56_tmp_0_dim, transpose_28_tmp_0_dim, axis_270, 5);
	free(reshape2_56_tmp_0);

	float* relu_72_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_fusion_elementwise_add_activation(tmp_30, nearest_interp_v2_10_tmp_0, relu_72_tmp_0, tmp_30_dim, nearest_interp_v2_10_tmp_0_dim, relu_72_tmp_0_dim, "relu", -1);
	free(tmp_30);
	...
	autox_conv2d(split_29_tmp_1, weights + 313760, weights + 313800, relu_79_tmp_0, split_29_tmp_1_dim, conv2d_135_w_0_dim, relu_79_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_29_tmp_1);

	float* batch_norm_136_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(relu_79_tmp_0, weights + 315400, weights + 315440, batch_norm_136_tmp_2, relu_79_tmp_0_dim, conv2d_136_w_0_dim, batch_norm_136_tmp_2_dim, 40, 1, 1, 1, 0);
	free(relu_79_tmp_0);

	float* relu_80_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_136_tmp_2, weights + 315800, weights + 315840, relu_80_tmp_0, batch_norm_136_tmp_2_dim, conv2d_137_w_0_dim, relu_80_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_58_tmp_0, transpose_29_tmp_0, reshape2_58_tmp_0_dim, transpose_29_tmp_0_dim, axis_277, 5);
	free(reshape2_58_tmp_0);
	...
	autox_split(reshape2_59_tmp_0, p_278, reshape2_59_tmp_0_dim, p_278_dim, 1, 4, 2, 4);
	free(reshape2_59_tmp_0);

	float* relu_81_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(split_30_tmp_1, weights + 317440, weights + 317480, relu_81_tmp_0, split_30_tmp_1_dim, conv2d_138_w_0_dim, relu_81_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_30_tmp_1);

	float* batch_norm_139_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(relu_81_tmp_0, weights + 319080, weights + 319120, batch_norm_139_tmp_2, relu_81_tmp_0_dim, conv2d_139_w_0_dim, batch_norm_139_tmp_2_dim, 40, 1, 1, 1, 0);
	free(relu_81_tmp_0);

	float* relu_82_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_139_tmp_2, weights + 319480, weights + 319520, relu_82_tmp_0, batch_norm_139_tmp_2_dim, conv2d_140_w_0_dim, relu_82_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_60_tmp_0, transpose_30_tmp_0, reshape2_60_tmp_0_dim, transpose_30_tmp_0_dim, axis_283, 5);
	free(reshape2_60_tmp_0);

	float* relu_74_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_fusion_elementwise_add_activation(tmp_33, reshape2_53_tmp_0, relu_74_tmp_0, tmp_33_dim, reshape2_53_tmp_0_dim, relu_74_tmp_0_dim, "relu", -1);
	free(tmp_33);
	free(reshape2_53_tmp_0);
	...
	autox_conv2d(split_31_tmp_1, weights + 321120, weights + 321200, relu_83_tmp_0, split_31_tmp_1_dim, conv2d_141_w_0_dim, relu_83_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_31_tmp_1);

	float* batch_norm_142_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(relu_83_tmp_0, weights + 327600, weights + 327680, batch_norm_142_tmp_2, relu_83_tmp_0_dim, conv2d_142_w_0_dim, batch_norm_142_tmp_2_dim, 80, 1, 1, 1, 0);
	free(relu_83_tmp_0);

	float* relu_84_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_142_tmp_2, weights + 328400, weights + 328480, relu_84_tmp_0, batch_norm_142_tmp_2_dim, conv2d_143_w_0_dim, relu_84_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_62_tmp_0, transpose_31_tmp_0, reshape2_62_tmp_0_dim, transpose_31_tmp_0_dim, axis_290, 5);
	free(reshape2_62_tmp_0);
	...
	autox_split(reshape2_63_tmp_0, p_291, reshape2_63_tmp_0_dim, p_291_dim, 1, 4, 2, 4);
	free(reshape2_63_tmp_0);

	float* relu_85_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(split_32_tmp_1, weights + 334880, weights + 334960, relu_85_tmp_0, split_32_tmp_1_dim, conv2d_144_w_0_dim, relu_85_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_32_tmp_1);

	float* batch_norm_145_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(relu_85_tmp_0, weights + 341360, weights + 341440, batch_norm_145_tmp_2, relu_85_tmp_0_dim, conv2d_145_w_0_dim, batch_norm_145_tmp_2_dim, 80, 1, 1, 1, 0);
	free(relu_85_tmp_0);

	float* relu_86_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_145_tmp_2, weights + 342160, weights + 342240, relu_86_tmp_0, batch_norm_145_tmp_2_dim, conv2d_146_w_0_dim, relu_86_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_64_tmp_0, transpose_32_tmp_0, reshape2_64_tmp_0_dim, transpose_32_tmp_0_dim, axis_296, 5);
	free(reshape2_64_tmp_0);

	float* tmp_35 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(reshape2_57_tmp_0, reshape2_57_tmp_0, tmp_35, reshape2_57_tmp_0_dim, reshape2_57_tmp_0_dim, tmp_35_dim, -1, 4, 4);
	free(reshape2_57_tmp_0);
	free(reshape2_57_tmp_0);

	float* batch_norm_147_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(reshape2_61_tmp_0, weights + 348640, weights + 348680, batch_norm_147_tmp_2, reshape2_61_tmp_0_dim, conv2d_147_w_0_dim, batch_norm_147_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_61_tmp_0);

	float* nearest_interp_v2_11_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_nearest_interp_v2(batch_norm_147_tmp_2, nearest_interp_v2_11_tmp_0, batch_norm_147_tmp_2_dim, nearest_interp_v2_11_tmp_0_dim);
	free(batch_norm_147_tmp_2);

	float* tmp_36 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(tmp_35, nearest_interp_v2_11_tmp_0, tmp_36, tmp_35_dim, nearest_interp_v2_11_tmp_0_dim, tmp_36_dim, -1, 4, 4);
	free(tmp_35);
	free(nearest_interp_v2_11_tmp_0);

	float* batch_norm_148_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(reshape2_65_tmp_0, weights + 351880, weights + 351920, batch_norm_148_tmp_2, reshape2_65_tmp_0_dim, conv2d_148_w_0_dim, batch_norm_148_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_65_tmp_0);

	float* nearest_interp_v2_12_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_nearest_interp_v2(batch_norm_148_tmp_2, nearest_interp_v2_12_tmp_0, batch_norm_148_tmp_2_dim, nearest_interp_v2_12_tmp_0_dim);
	free(batch_norm_148_tmp_2);

	float* tmp_37 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(tmp_36, nearest_interp_v2_12_tmp_0, tmp_37, tmp_36_dim, nearest_interp_v2_12_tmp_0_dim, tmp_37_dim, -1, 4, 4);
	free(tmp_36);
	free(nearest_interp_v2_12_tmp_0);

	float* relu_87_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_relu(tmp_37, relu_87_tmp_0, tmp_37_dim, relu_87_tmp_0_dim);
	free(tmp_37);

	float* batch_norm_149_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(tmp_37, weights + 358320, weights + 358360, batch_norm_149_tmp_2, tmp_37_dim, conv2d_149_w_0_dim, batch_norm_149_tmp_2_dim, 40, 1, 2, 1, 0);
	free(tmp_37);

	float* batch_norm_150_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_149_tmp_2, weights + 358720, weights + 358800, batch_norm_150_tmp_2, batch_norm_149_tmp_2_dim, conv2d_150_w_0_dim, batch_norm_150_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_149_tmp_2);

	float* tmp_38 = (float*)calloc(15360, sizeof(float));
	autox_elementwise_add(batch_norm_150_tmp_2, batch_norm_150_tmp_2, tmp_38, batch_norm_150_tmp_2_dim, batch_norm_150_tmp_2_dim, tmp_38_dim, -1, 4, 4);
	free(batch_norm_150_tmp_2);
	free(batch_norm_150_tmp_2);

	float* tmp_39 = (float*)calloc(15360, sizeof(float));
	autox_elementwise_add(tmp_38, reshape2_61_tmp_0, tmp_39, tmp_38_dim, reshape2_61_tmp_0_dim, tmp_39_dim, -1, 4, 4);
	free(tmp_38);
	free(reshape2_61_tmp_0);

	float* batch_norm_151_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(reshape2_65_tmp_0, weights + 362000, weights + 362080, batch_norm_151_tmp_2, reshape2_65_tmp_0_dim, conv2d_151_w_0_dim, batch_norm_151_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_65_tmp_0);

	float* nearest_interp_v2_13_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_nearest_interp_v2(batch_norm_151_tmp_2, nearest_interp_v2_13_tmp_0, batch_norm_151_tmp_2_dim, nearest_interp_v2_13_tmp_0_dim);
	free(batch_norm_151_tmp_2);

	float* batch_norm_152_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(tmp_37, weights + 374880, weights + 374920, batch_norm_152_tmp_2, tmp_37_dim, conv2d_152_w_0_dim, batch_norm_152_tmp_2_dim, 40, 1, 2, 1, 0);
	free(tmp_37);

	float* relu_89_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_152_tmp_2, weights + 375280, weights + 375320, relu_89_tmp_0, batch_norm_152_tmp_2_dim, conv2d_153_w_0_dim, relu_89_tmp_0_dim, 1, 0, 1, 1, 1);
	free(batch_norm_152_tmp_2);

	float* batch_norm_154_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(relu_89_tmp_0, weights + 376920, weights + 376960, batch_norm_154_tmp_2, relu_89_tmp_0_dim, conv2d_154_w_0_dim, batch_norm_154_tmp_2_dim, 40, 1, 2, 1, 0);
	free(relu_89_tmp_0);

	float* batch_norm_155_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_154_tmp_2, weights + 377320, weights + 377480, batch_norm_155_tmp_2, batch_norm_154_tmp_2_dim, conv2d_155_w_0_dim, batch_norm_155_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_154_tmp_2);

	float* tmp_41 = (float*)calloc(7680, sizeof(float));
	autox_elementwise_add(batch_norm_155_tmp_2, batch_norm_155_tmp_2, tmp_41, batch_norm_155_tmp_2_dim, batch_norm_155_tmp_2_dim, tmp_41_dim, -1, 4, 4);
	free(batch_norm_155_tmp_2);
	free(batch_norm_155_tmp_2);

	float* batch_norm_156_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(reshape2_61_tmp_0, weights + 383880, weights + 383960, batch_norm_156_tmp_2, reshape2_61_tmp_0_dim, conv2d_156_w_0_dim, batch_norm_156_tmp_2_dim, 80, 1, 2, 1, 0);
	free(reshape2_61_tmp_0);

	float* batch_norm_157_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_156_tmp_2, weights + 384680, weights + 384840, batch_norm_157_tmp_2, batch_norm_156_tmp_2_dim, conv2d_157_w_0_dim, batch_norm_157_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_156_tmp_2);

	float* tmp_42 = (float*)calloc(7680, sizeof(float));
	autox_elementwise_add(tmp_41, batch_norm_157_tmp_2, tmp_42, tmp_41_dim, batch_norm_157_tmp_2_dim, tmp_42_dim, -1, 4, 4);
	free(tmp_41);
	free(batch_norm_157_tmp_2);

	float* relu_90_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_fusion_elementwise_add_activation(tmp_42, reshape2_65_tmp_0, relu_90_tmp_0, tmp_42_dim, reshape2_65_tmp_0_dim, relu_90_tmp_0_dim, "relu", -1);
	free(tmp_42);
	free(reshape2_65_tmp_0);

	float* batch_norm_158_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(relu_90_tmp_0, weights + 397640, weights + 397800, batch_norm_158_tmp_2, relu_90_tmp_0_dim, conv2d_158_w_0_dim, batch_norm_158_tmp_2_dim, 160, 1, 2, 1, 0);
	free(relu_90_tmp_0);
	...
	autox_conv2d(split_33_tmp_1, weights + 399240, weights + 399260, relu_92_tmp_0, split_33_tmp_1_dim, conv2d_160_w_0_dim, relu_92_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_33_tmp_1);

	float* batch_norm_161_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(relu_92_tmp_0, weights + 399660, weights + 399680, batch_norm_161_tmp_2, relu_92_tmp_0_dim, conv2d_161_w_0_dim, batch_norm_161_tmp_2_dim, 20, 1, 1, 1, 0);
	free(relu_92_tmp_0);

	float* relu_93_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_161_tmp_2, weights + 399860, weights + 399880, relu_93_tmp_0, batch_norm_161_tmp_2_dim, conv2d_162_w_0_dim, relu_93_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_66_tmp_0, transpose_33_tmp_0, reshape2_66_tmp_0_dim, transpose_33_tmp_0_dim, axis_326, 5);
	free(reshape2_66_tmp_0);
	...
	autox_split(reshape2_67_tmp_0, p_327, reshape2_67_tmp_0_dim, p_327_dim, 1, 4, 2, 4);
	free(reshape2_67_tmp_0);

	float* relu_94_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(split_34_tmp_1, weights + 400280, weights + 400300, relu_94_tmp_0, split_34_tmp_1_dim, conv2d_163_w_0_dim, relu_94_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_34_tmp_1);

	float* batch_norm_164_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(relu_94_tmp_0, weights + 400700, weights + 400720, batch_norm_164_tmp_2, relu_94_tmp_0_dim, conv2d_164_w_0_dim, batch_norm_164_tmp_2_dim, 20, 1, 1, 1, 0);
	free(relu_94_tmp_0);

	float* relu_95_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_164_tmp_2, weights + 400900, weights + 400920, relu_95_tmp_0, batch_norm_164_tmp_2_dim, conv2d_165_w_0_dim, relu_95_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_68_tmp_0, transpose_34_tmp_0, reshape2_68_tmp_0_dim, transpose_34_tmp_0_dim, axis_332, 5);
	free(reshape2_68_tmp_0);

	float* relu_88_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_fusion_elementwise_add_activation(tmp_39, nearest_interp_v2_13_tmp_0, relu_88_tmp_0, tmp_39_dim, nearest_interp_v2_13_tmp_0_dim, relu_88_tmp_0_dim, "relu", -1);
	free(tmp_39);
	...
	autox_conv2d(split_35_tmp_1, weights + 401320, weights + 401360, relu_96_tmp_0, split_35_tmp_1_dim, conv2d_166_w_0_dim, relu_96_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_35_tmp_1);

	float* batch_norm_167_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(relu_96_tmp_0, weights + 402960, weights + 403000, batch_norm_167_tmp_2, relu_96_tmp_0_dim, conv2d_167_w_0_dim, batch_norm_167_tmp_2_dim, 40, 1, 1, 1, 0);
	free(relu_96_tmp_0);

	float* relu_97_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_167_tmp_2, weights + 403360, weights + 403400, relu_97_tmp_0, batch_norm_167_tmp_2_dim, conv2d_168_w_0_dim, relu_97_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_70_tmp_0, transpose_35_tmp_0, reshape2_70_tmp_0_dim, transpose_35_tmp_0_dim, axis_339, 5);
	free(reshape2_70_tmp_0);
	...
	autox_split(reshape2_71_tmp_0, p_340, reshape2_71_tmp_0_dim, p_340_dim, 1, 4, 2, 4);
	free(reshape2_71_tmp_0);

	float* relu_98_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(split_36_tmp_1, weights + 405000, weights + 405040, relu_98_tmp_0, split_36_tmp_1_dim, conv2d_169_w_0_dim, relu_98_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_36_tmp_1);

	float* batch_norm_170_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(relu_98_tmp_0, weights + 406640, weights + 406680, batch_norm_170_tmp_2, relu_98_tmp_0_dim, conv2d_170_w_0_dim, batch_norm_170_tmp_2_dim, 40, 1, 1, 1, 0);
	free(relu_98_tmp_0);

	float* relu_99_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_170_tmp_2, weights + 407040, weights + 407080, relu_99_tmp_0, batch_norm_170_tmp_2_dim, conv2d_171_w_0_dim, relu_99_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_72_tmp_0, transpose_36_tmp_0, reshape2_72_tmp_0_dim, transpose_36_tmp_0_dim, axis_345, 5);
	free(reshape2_72_tmp_0);
	...
	autox_conv2d(split_37_tmp_1, weights + 408680, weights + 408760, relu_100_tmp_0, split_37_tmp_1_dim, conv2d_172_w_0_dim, relu_100_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_37_tmp_1);

	float* batch_norm_173_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(relu_100_tmp_0, weights + 415160, weights + 415240, batch_norm_173_tmp_2, relu_100_tmp_0_dim, conv2d_173_w_0_dim, batch_norm_173_tmp_2_dim, 80, 1, 1, 1, 0);
	free(relu_100_tmp_0);

	float* relu_101_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_173_tmp_2, weights + 415960, weights + 416040, relu_101_tmp_0, batch_norm_173_tmp_2_dim, conv2d_174_w_0_dim, relu_101_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_74_tmp_0, transpose_37_tmp_0, reshape2_74_tmp_0_dim, transpose_37_tmp_0_dim, axis_351, 5);
	free(reshape2_74_tmp_0);
	...
	autox_split(reshape2_75_tmp_0, p_352, reshape2_75_tmp_0_dim, p_352_dim, 1, 4, 2, 4);
	free(reshape2_75_tmp_0);

	float* relu_102_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(split_38_tmp_1, weights + 422440, weights + 422520, relu_102_tmp_0, split_38_tmp_1_dim, conv2d_175_w_0_dim, relu_102_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_38_tmp_1);

	float* batch_norm_176_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(relu_102_tmp_0, weights + 428920, weights + 429000, batch_norm_176_tmp_2, relu_102_tmp_0_dim, conv2d_176_w_0_dim, batch_norm_176_tmp_2_dim, 80, 1, 1, 1, 0);
	free(relu_102_tmp_0);

	float* relu_103_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_176_tmp_2, weights + 429720, weights + 429800, relu_103_tmp_0, batch_norm_176_tmp_2_dim, conv2d_177_w_0_dim, relu_103_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_76_tmp_0, transpose_38_tmp_0, reshape2_76_tmp_0_dim, transpose_38_tmp_0_dim, axis_357, 5);
	free(reshape2_76_tmp_0);

	float* relu_91_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_158_tmp_2, weights + 436200, weights + 436520, relu_91_tmp_0, batch_norm_158_tmp_2_dim, conv2d_159_w_0_dim, relu_91_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_conv2d(split_39_tmp_1, weights + 487720, weights + 487880, relu_104_tmp_0, split_39_tmp_1_dim, conv2d_178_w_0_dim, relu_104_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_39_tmp_1);

	float* batch_norm_179_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(relu_104_tmp_0, weights + 513480, weights + 513640, batch_norm_179_tmp_2, relu_104_tmp_0_dim, conv2d_179_w_0_dim, batch_norm_179_tmp_2_dim, 160, 1, 1, 1, 0);
	free(relu_104_tmp_0);

	float* relu_105_tmp_0 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(batch_norm_179_tmp_2, weights + 515080, weights + 515240, relu_105_tmp_0, batch_norm_179_tmp_2_dim, conv2d_180_w_0_dim, relu_105_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_78_tmp_0, transpose_39_tmp_0, reshape2_78_tmp_0_dim, transpose_39_tmp_0_dim, axis_364, 5);
	free(reshape2_78_tmp_0);
	...
	autox_split(reshape2_79_tmp_0, p_365, reshape2_79_tmp_0_dim, p_365_dim, 1, 4, 2, 4);
	free(reshape2_79_tmp_0);

	float* relu_106_tmp_0 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(split_40_tmp_1, weights + 540840, weights + 541000, relu_106_tmp_0, split_40_tmp_1_dim, conv2d_181_w_0_dim, relu_106_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_40_tmp_1);

	float* batch_norm_182_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(relu_106_tmp_0, weights + 566600, weights + 566760, batch_norm_182_tmp_2, relu_106_tmp_0_dim, conv2d_182_w_0_dim, batch_norm_182_tmp_2_dim, 160, 1, 1, 1, 0);
	free(relu_106_tmp_0);

	float* relu_107_tmp_0 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(batch_norm_182_tmp_2, weights + 568200, weights + 568360, relu_107_tmp_0, batch_norm_182_tmp_2_dim, conv2d_183_w_0_dim, relu_107_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_80_tmp_0, transpose_40_tmp_0, reshape2_80_tmp_0_dim, transpose_40_tmp_0_dim, axis_370, 5);
	free(reshape2_80_tmp_0);

	float* tmp_44 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(reshape2_69_tmp_0, reshape2_69_tmp_0, tmp_44, reshape2_69_tmp_0_dim, reshape2_69_tmp_0_dim, tmp_44_dim, -1, 4, 4);
	free(reshape2_69_tmp_0);
	free(reshape2_69_tmp_0);

	float* batch_norm_184_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(reshape2_73_tmp_0, weights + 593960, weights + 594000, batch_norm_184_tmp_2, reshape2_73_tmp_0_dim, conv2d_184_w_0_dim, batch_norm_184_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_73_tmp_0);

	float* nearest_interp_v2_14_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_nearest_interp_v2(batch_norm_184_tmp_2, nearest_interp_v2_14_tmp_0, batch_norm_184_tmp_2_dim, nearest_interp_v2_14_tmp_0_dim);
	free(batch_norm_184_tmp_2);

	float* tmp_45 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(tmp_44, nearest_interp_v2_14_tmp_0, tmp_45, tmp_44_dim, nearest_interp_v2_14_tmp_0_dim, tmp_45_dim, -1, 4, 4);
	free(tmp_44);
	free(nearest_interp_v2_14_tmp_0);

	float* batch_norm_185_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(reshape2_77_tmp_0, weights + 597200, weights + 597240, batch_norm_185_tmp_2, reshape2_77_tmp_0_dim, conv2d_185_w_0_dim, batch_norm_185_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_77_tmp_0);

	float* nearest_interp_v2_15_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_nearest_interp_v2(batch_norm_185_tmp_2, nearest_interp_v2_15_tmp_0, batch_norm_185_tmp_2_dim, nearest_interp_v2_15_tmp_0_dim);
	free(batch_norm_185_tmp_2);

	float* tmp_46 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(tmp_45, nearest_interp_v2_15_tmp_0, tmp_46, tmp_45_dim, nearest_interp_v2_15_tmp_0_dim, tmp_46_dim, -1, 4, 4);
	free(tmp_45);
	free(nearest_interp_v2_15_tmp_0);

	float* batch_norm_186_tmp_2 = (float*)calloc(480, sizeof(float));
	autox_conv2d(reshape2_81_tmp_0, weights + 603640, weights + 603680, batch_norm_186_tmp_2, reshape2_81_tmp_0_dim, conv2d_186_w_0_dim, batch_norm_186_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_81_tmp_0);

	float* nearest_interp_v2_16_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_nearest_interp_v2(batch_norm_186_tmp_2, nearest_interp_v2_16_tmp_0, batch_norm_186_tmp_2_dim, nearest_interp_v2_16_tmp_0_dim);
	free(batch_norm_186_tmp_2);

	float* tmp_47 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(tmp_46, nearest_interp_v2_16_tmp_0, tmp_47, tmp_46_dim, nearest_interp_v2_16_tmp_0_dim, tmp_47_dim, -1, 4, 4);
	free(tmp_46);
	free(nearest_interp_v2_16_tmp_0);

	float* relu_108_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_relu(tmp_47, relu_108_tmp_0, tmp_47_dim, relu_108_tmp_0_dim);
	free(tmp_47);

	float* batch_norm_187_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(tmp_47, weights + 616480, weights + 616520, batch_norm_187_tmp_2, tmp_47_dim, conv2d_187_w_0_dim, batch_norm_187_tmp_2_dim, 40, 1, 2, 1, 0);
	free(tmp_47);

	float* batch_norm_188_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_187_tmp_2, weights + 616880, weights + 616960, batch_norm_188_tmp_2, batch_norm_187_tmp_2_dim, conv2d_188_w_0_dim, batch_norm_188_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_187_tmp_2);

	float* tmp_48 = (float*)calloc(15360, sizeof(float));
	autox_elementwise_add(batch_norm_188_tmp_2, batch_norm_188_tmp_2, tmp_48, batch_norm_188_tmp_2_dim, batch_norm_188_tmp_2_dim, tmp_48_dim, -1, 4, 4);
	free(batch_norm_188_tmp_2);
	free(batch_norm_188_tmp_2);

	float* tmp_49 = (float*)calloc(15360, sizeof(float));
	autox_elementwise_add(tmp_48, reshape2_73_tmp_0, tmp_49, tmp_48_dim, reshape2_73_tmp_0_dim, tmp_49_dim, -1, 4, 4);
	free(tmp_48);
	free(reshape2_73_tmp_0);

	float* batch_norm_189_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(reshape2_77_tmp_0, weights + 620160, weights + 620240, batch_norm_189_tmp_2, reshape2_77_tmp_0_dim, conv2d_189_w_0_dim, batch_norm_189_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_77_tmp_0);

	float* nearest_interp_v2_17_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_nearest_interp_v2(batch_norm_189_tmp_2, nearest_interp_v2_17_tmp_0, batch_norm_189_tmp_2_dim, nearest_interp_v2_17_tmp_0_dim);
	free(batch_norm_189_tmp_2);

	float* tmp_50 = (float*)calloc(15360, sizeof(float));
	autox_elementwise_add(tmp_49, nearest_interp_v2_17_tmp_0, tmp_50, tmp_49_dim, nearest_interp_v2_17_tmp_0_dim, tmp_50_dim, -1, 4, 4);
	free(tmp_49);
	free(nearest_interp_v2_17_tmp_0);

	float* batch_norm_190_tmp_2 = (float*)calloc(960, sizeof(float));
	autox_conv2d(reshape2_81_tmp_0, weights + 633040, weights + 633120, batch_norm_190_tmp_2, reshape2_81_tmp_0_dim, conv2d_190_w_0_dim, batch_norm_190_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_81_tmp_0);

	float* nearest_interp_v2_18_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_nearest_interp_v2(batch_norm_190_tmp_2, nearest_interp_v2_18_tmp_0, batch_norm_190_tmp_2_dim, nearest_interp_v2_18_tmp_0_dim);
	free(batch_norm_190_tmp_2);

	float* batch_norm_191_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(tmp_47, weights + 658720, weights + 658760, batch_norm_191_tmp_2, tmp_47_dim, conv2d_191_w_0_dim, batch_norm_191_tmp_2_dim, 40, 1, 2, 1, 0);
	free(tmp_47);

	float* relu_110_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_191_tmp_2, weights + 659120, weights + 659160, relu_110_tmp_0, batch_norm_191_tmp_2_dim, conv2d_192_w_0_dim, relu_110_tmp_0_dim, 1, 0, 1, 1, 1);
	free(batch_norm_191_tmp_2);

	float* batch_norm_193_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(relu_110_tmp_0, weights + 660760, weights + 660800, batch_norm_193_tmp_2, relu_110_tmp_0_dim, conv2d_193_w_0_dim, batch_norm_193_tmp_2_dim, 40, 1, 2, 1, 0);
	free(relu_110_tmp_0);

	float* batch_norm_194_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_193_tmp_2, weights + 661160, weights + 661320, batch_norm_194_tmp_2, batch_norm_193_tmp_2_dim, conv2d_194_w_0_dim, batch_norm_194_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_193_tmp_2);

	float* tmp_52 = (float*)calloc(7680, sizeof(float));
	autox_elementwise_add(batch_norm_194_tmp_2, batch_norm_194_tmp_2, tmp_52, batch_norm_194_tmp_2_dim, batch_norm_194_tmp_2_dim, tmp_52_dim, -1, 4, 4);
	free(batch_norm_194_tmp_2);
	free(batch_norm_194_tmp_2);

	float* batch_norm_195_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(reshape2_73_tmp_0, weights + 667720, weights + 667800, batch_norm_195_tmp_2, reshape2_73_tmp_0_dim, conv2d_195_w_0_dim, batch_norm_195_tmp_2_dim, 80, 1, 2, 1, 0);
	free(reshape2_73_tmp_0);

	float* batch_norm_196_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_195_tmp_2, weights + 668520, weights + 668680, batch_norm_196_tmp_2, batch_norm_195_tmp_2_dim, conv2d_196_w_0_dim, batch_norm_196_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_195_tmp_2);

	float* tmp_53 = (float*)calloc(7680, sizeof(float));
	autox_elementwise_add(tmp_52, batch_norm_196_tmp_2, tmp_53, tmp_52_dim, batch_norm_196_tmp_2_dim, tmp_53_dim, -1, 4, 4);
	free(tmp_52);
	free(batch_norm_196_tmp_2);

	float* tmp_54 = (float*)calloc(7680, sizeof(float));
	autox_elementwise_add(tmp_53, reshape2_77_tmp_0, tmp_54, tmp_53_dim, reshape2_77_tmp_0_dim, tmp_54_dim, -1, 4, 4);
	free(tmp_53);
	free(reshape2_77_tmp_0);

	float* batch_norm_197_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(reshape2_81_tmp_0, weights + 681480, weights + 681640, batch_norm_197_tmp_2, reshape2_81_tmp_0_dim, conv2d_197_w_0_dim, batch_norm_197_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_81_tmp_0);

	float* nearest_interp_v2_19_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_nearest_interp_v2(batch_norm_197_tmp_2, nearest_interp_v2_19_tmp_0, batch_norm_197_tmp_2_dim, nearest_interp_v2_19_tmp_0_dim);
	free(batch_norm_197_tmp_2);

	float* batch_norm_198_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(tmp_47, weights + 732840, weights + 732880, batch_norm_198_tmp_2, tmp_47_dim, conv2d_198_w_0_dim, batch_norm_198_tmp_2_dim, 40, 1, 2, 1, 0);
	free(tmp_47);

	float* relu_112_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_198_tmp_2, weights + 733240, weights + 733280, relu_112_tmp_0, batch_norm_198_tmp_2_dim, conv2d_199_w_0_dim, relu_112_tmp_0_dim, 1, 0, 1, 1, 1);
	free(batch_norm_198_tmp_2);

	float* batch_norm_200_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(relu_112_tmp_0, weights + 734880, weights + 734920, batch_norm_200_tmp_2, relu_112_tmp_0_dim, conv2d_200_w_0_dim, batch_norm_200_tmp_2_dim, 40, 1, 2, 1, 0);
	free(relu_112_tmp_0);

	float* relu_113_tmp_0 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(batch_norm_200_tmp_2, weights + 735280, weights + 735320, relu_113_tmp_0, batch_norm_200_tmp_2_dim, conv2d_201_w_0_dim, relu_113_tmp_0_dim, 1, 0, 1, 1, 1);
	free(batch_norm_200_tmp_2);

	float* batch_norm_202_tmp_2 = (float*)calloc(480, sizeof(float));
	autox_conv2d(relu_113_tmp_0, weights + 736920, weights + 736960, batch_norm_202_tmp_2, relu_113_tmp_0_dim, conv2d_202_w_0_dim, batch_norm_202_tmp_2_dim, 40, 1, 2, 1, 0);
	free(relu_113_tmp_0);

	float* batch_norm_203_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_202_tmp_2, weights + 737320, weights + 737640, batch_norm_203_tmp_2, batch_norm_202_tmp_2_dim, conv2d_203_w_0_dim, batch_norm_203_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_202_tmp_2);

	float* tmp_56 = (float*)calloc(3840, sizeof(float));
	autox_elementwise_add(batch_norm_203_tmp_2, batch_norm_203_tmp_2, tmp_56, batch_norm_203_tmp_2_dim, batch_norm_203_tmp_2_dim, tmp_56_dim, -1, 4, 4);
	free(batch_norm_203_tmp_2);
	free(batch_norm_203_tmp_2);

	float* batch_norm_204_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(reshape2_73_tmp_0, weights + 750440, weights + 750520, batch_norm_204_tmp_2, reshape2_73_tmp_0_dim, conv2d_204_w_0_dim, batch_norm_204_tmp_2_dim, 80, 1, 2, 1, 0);
	free(reshape2_73_tmp_0);

	float* relu_114_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_204_tmp_2, weights + 751240, weights + 751320, relu_114_tmp_0, batch_norm_204_tmp_2_dim, conv2d_205_w_0_dim, relu_114_tmp_0_dim, 1, 0, 1, 1, 1);
	free(batch_norm_204_tmp_2);

	float* batch_norm_206_tmp_2 = (float*)calloc(960, sizeof(float));
	autox_conv2d(relu_114_tmp_0, weights + 757720, weights + 757800, batch_norm_206_tmp_2, relu_114_tmp_0_dim, conv2d_206_w_0_dim, batch_norm_206_tmp_2_dim, 80, 1, 2, 1, 0);
	free(relu_114_tmp_0);

	float* batch_norm_207_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_206_tmp_2, weights + 758520, weights + 758840, batch_norm_207_tmp_2, batch_norm_206_tmp_2_dim, conv2d_207_w_0_dim, batch_norm_207_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_206_tmp_2);

	float* tmp_57 = (float*)calloc(3840, sizeof(float));
	autox_elementwise_add(tmp_56, batch_norm_207_tmp_2, tmp_57, tmp_56_dim, batch_norm_207_tmp_2_dim, tmp_57_dim, -1, 4, 4);
	free(tmp_56);
	free(batch_norm_207_tmp_2);

	float* batch_norm_208_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(reshape2_77_tmp_0, weights + 784440, weights + 784600, batch_norm_208_tmp_2, reshape2_77_tmp_0_dim, conv2d_208_w_0_dim, batch_norm_208_tmp_2_dim, 160, 1, 2, 1, 0);
	free(reshape2_77_tmp_0);

	float* batch_norm_209_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_208_tmp_2, weights + 786040, weights + 786360, batch_norm_209_tmp_2, batch_norm_208_tmp_2_dim, conv2d_209_w_0_dim, batch_norm_209_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_208_tmp_2);

	float* tmp_58 = (float*)calloc(3840, sizeof(float));
	autox_elementwise_add(tmp_57, batch_norm_209_tmp_2, tmp_58, tmp_57_dim, batch_norm_209_tmp_2_dim, tmp_58_dim, -1, 4, 4);
	free(tmp_57);
	...
	autox_conv2d(split_41_tmp_1, weights + 837560, weights + 837580, relu_116_tmp_0, split_41_tmp_1_dim, conv2d_210_w_0_dim, relu_116_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_41_tmp_1);

	float* batch_norm_211_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(relu_116_tmp_0, weights + 837980, weights + 838000, batch_norm_211_tmp_2, relu_116_tmp_0_dim, conv2d_211_w_0_dim, batch_norm_211_tmp_2_dim, 20, 1, 1, 1, 0);
	free(relu_116_tmp_0);

	float* relu_117_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_211_tmp_2, weights + 838180, weights + 838200, relu_117_tmp_0, batch_norm_211_tmp_2_dim, conv2d_212_w_0_dim, relu_117_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_82_tmp_0, transpose_41_tmp_0, reshape2_82_tmp_0_dim, transpose_41_tmp_0_dim, axis_422, 5);
	free(reshape2_82_tmp_0);
	...
	autox_split(reshape2_83_tmp_0, p_423, reshape2_83_tmp_0_dim, p_423_dim, 1, 4, 2, 4);
	free(reshape2_83_tmp_0);

	float* relu_118_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(split_42_tmp_1, weights + 838600, weights + 838620, relu_118_tmp_0, split_42_tmp_1_dim, conv2d_213_w_0_dim, relu_118_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_42_tmp_1);

	float* batch_norm_214_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(relu_118_tmp_0, weights + 839020, weights + 839040, batch_norm_214_tmp_2, relu_118_tmp_0_dim, conv2d_214_w_0_dim, batch_norm_214_tmp_2_dim, 20, 1, 1, 1, 0);
	free(relu_118_tmp_0);

	float* relu_119_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_214_tmp_2, weights + 839220, weights + 839240, relu_119_tmp_0, batch_norm_214_tmp_2_dim, conv2d_215_w_0_dim, relu_119_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_84_tmp_0, transpose_42_tmp_0, reshape2_84_tmp_0_dim, transpose_42_tmp_0_dim, axis_428, 5);
	free(reshape2_84_tmp_0);

	float* relu_109_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_fusion_elementwise_add_activation(tmp_50, nearest_interp_v2_18_tmp_0, relu_109_tmp_0, tmp_50_dim, nearest_interp_v2_18_tmp_0_dim, relu_109_tmp_0_dim, "relu", -1);
	free(tmp_50);
	...
	autox_conv2d(split_43_tmp_1, weights + 839640, weights + 839680, relu_120_tmp_0, split_43_tmp_1_dim, conv2d_216_w_0_dim, relu_120_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_43_tmp_1);

	float* batch_norm_217_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(relu_120_tmp_0, weights + 841280, weights + 841320, batch_norm_217_tmp_2, relu_120_tmp_0_dim, conv2d_217_w_0_dim, batch_norm_217_tmp_2_dim, 40, 1, 1, 1, 0);
	free(relu_120_tmp_0);

	float* relu_121_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_217_tmp_2, weights + 841680, weights + 841720, relu_121_tmp_0, batch_norm_217_tmp_2_dim, conv2d_218_w_0_dim, relu_121_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_86_tmp_0, transpose_43_tmp_0, reshape2_86_tmp_0_dim, transpose_43_tmp_0_dim, axis_435, 5);
	free(reshape2_86_tmp_0);
	...
	autox_split(reshape2_87_tmp_0, p_436, reshape2_87_tmp_0_dim, p_436_dim, 1, 4, 2, 4);
	free(reshape2_87_tmp_0);

	float* relu_122_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(split_44_tmp_1, weights + 843320, weights + 843360, relu_122_tmp_0, split_44_tmp_1_dim, conv2d_219_w_0_dim, relu_122_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_44_tmp_1);

	float* batch_norm_220_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(relu_122_tmp_0, weights + 844960, weights + 845000, batch_norm_220_tmp_2, relu_122_tmp_0_dim, conv2d_220_w_0_dim, batch_norm_220_tmp_2_dim, 40, 1, 1, 1, 0);
	free(relu_122_tmp_0);

	float* relu_123_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_220_tmp_2, weights + 845360, weights + 845400, relu_123_tmp_0, batch_norm_220_tmp_2_dim, conv2d_221_w_0_dim, relu_123_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_88_tmp_0, transpose_44_tmp_0, reshape2_88_tmp_0_dim, transpose_44_tmp_0_dim, axis_441, 5);
	free(reshape2_88_tmp_0);

	float* relu_111_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_fusion_elementwise_add_activation(tmp_54, nearest_interp_v2_19_tmp_0, relu_111_tmp_0, tmp_54_dim, nearest_interp_v2_19_tmp_0_dim, relu_111_tmp_0_dim, "relu", -1);
	free(tmp_54);
	...
	autox_conv2d(split_45_tmp_1, weights + 847000, weights + 847080, relu_124_tmp_0, split_45_tmp_1_dim, conv2d_222_w_0_dim, relu_124_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_45_tmp_1);

	float* batch_norm_223_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(relu_124_tmp_0, weights + 853480, weights + 853560, batch_norm_223_tmp_2, relu_124_tmp_0_dim, conv2d_223_w_0_dim, batch_norm_223_tmp_2_dim, 80, 1, 1, 1, 0);
	free(relu_124_tmp_0);

	float* relu_125_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_223_tmp_2, weights + 854280, weights + 854360, relu_125_tmp_0, batch_norm_223_tmp_2_dim, conv2d_224_w_0_dim, relu_125_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_90_tmp_0, transpose_45_tmp_0, reshape2_90_tmp_0_dim, transpose_45_tmp_0_dim, axis_448, 5);
	free(reshape2_90_tmp_0);
	...
	autox_split(reshape2_91_tmp_0, p_449, reshape2_91_tmp_0_dim, p_449_dim, 1, 4, 2, 4);
	free(reshape2_91_tmp_0);

	float* relu_126_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(split_46_tmp_1, weights + 860760, weights + 860840, relu_126_tmp_0, split_46_tmp_1_dim, conv2d_225_w_0_dim, relu_126_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_46_tmp_1);

	float* batch_norm_226_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(relu_126_tmp_0, weights + 867240, weights + 867320, batch_norm_226_tmp_2, relu_126_tmp_0_dim, conv2d_226_w_0_dim, batch_norm_226_tmp_2_dim, 80, 1, 1, 1, 0);
	free(relu_126_tmp_0);

	float* relu_127_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_226_tmp_2, weights + 868040, weights + 868120, relu_127_tmp_0, batch_norm_226_tmp_2_dim, conv2d_227_w_0_dim, relu_127_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_92_tmp_0, transpose_46_tmp_0, reshape2_92_tmp_0_dim, transpose_46_tmp_0_dim, axis_454, 5);
	free(reshape2_92_tmp_0);

	float* relu_115_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_fusion_elementwise_add_activation(tmp_58, reshape2_81_tmp_0, relu_115_tmp_0, tmp_58_dim, reshape2_81_tmp_0_dim, relu_115_tmp_0_dim, "relu", -1);
	free(tmp_58);
	free(reshape2_81_tmp_0);
	...
	autox_conv2d(split_47_tmp_1, weights + 874520, weights + 874680, relu_128_tmp_0, split_47_tmp_1_dim, conv2d_228_w_0_dim, relu_128_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_47_tmp_1);

	float* batch_norm_229_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(relu_128_tmp_0, weights + 900280, weights + 900440, batch_norm_229_tmp_2, relu_128_tmp_0_dim, conv2d_229_w_0_dim, batch_norm_229_tmp_2_dim, 160, 1, 1, 1, 0);
	free(relu_128_tmp_0);

	float* relu_129_tmp_0 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(batch_norm_229_tmp_2, weights + 901880, weights + 902040, relu_129_tmp_0, batch_norm_229_tmp_2_dim, conv2d_230_w_0_dim, relu_129_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_94_tmp_0, transpose_47_tmp_0, reshape2_94_tmp_0_dim, transpose_47_tmp_0_dim, axis_461, 5);
	free(reshape2_94_tmp_0);
	...
	autox_split(reshape2_95_tmp_0, p_462, reshape2_95_tmp_0_dim, p_462_dim, 1, 4, 2, 4);
	free(reshape2_95_tmp_0);

	float* relu_130_tmp_0 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(split_48_tmp_1, weights + 927640, weights + 927800, relu_130_tmp_0, split_48_tmp_1_dim, conv2d_231_w_0_dim, relu_130_tmp_0_dim, 1, 0, 1, 1, 1);
	free(split_48_tmp_1);

	float* batch_norm_232_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(relu_130_tmp_0, weights + 953400, weights + 953560, batch_norm_232_tmp_2, relu_130_tmp_0_dim, conv2d_232_w_0_dim, batch_norm_232_tmp_2_dim, 160, 1, 1, 1, 0);
	free(relu_130_tmp_0);

	float* relu_131_tmp_0 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(batch_norm_232_tmp_2, weights + 955000, weights + 955160, relu_131_tmp_0, batch_norm_232_tmp_2_dim, conv2d_233_w_0_dim, relu_131_tmp_0_dim, 1, 0, 1, 1, 1);
	...
	autox_transpose(reshape2_96_tmp_0, transpose_48_tmp_0, reshape2_96_tmp_0_dim, transpose_48_tmp_0_dim, axis_467, 5);
	free(reshape2_96_tmp_0);

	float* tmp_60 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(reshape2_85_tmp_0, reshape2_85_tmp_0, tmp_60, reshape2_85_tmp_0_dim, reshape2_85_tmp_0_dim, tmp_60_dim, -1, 4, 4);
	free(reshape2_85_tmp_0);
	free(reshape2_85_tmp_0);

	float* batch_norm_234_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(reshape2_89_tmp_0, weights + 980760, weights + 980800, batch_norm_234_tmp_2, reshape2_89_tmp_0_dim, conv2d_234_w_0_dim, batch_norm_234_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_89_tmp_0);

	float* nearest_interp_v2_20_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_nearest_interp_v2(batch_norm_234_tmp_2, nearest_interp_v2_20_tmp_0, batch_norm_234_tmp_2_dim, nearest_interp_v2_20_tmp_0_dim);
	free(batch_norm_234_tmp_2);

	float* tmp_61 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(tmp_60, nearest_interp_v2_20_tmp_0, tmp_61, tmp_60_dim, nearest_interp_v2_20_tmp_0_dim, tmp_61_dim, -1, 4, 4);
	free(tmp_60);
	free(nearest_interp_v2_20_tmp_0);

	float* batch_norm_235_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(reshape2_93_tmp_0, weights + 984000, weights + 984040, batch_norm_235_tmp_2, reshape2_93_tmp_0_dim, conv2d_235_w_0_dim, batch_norm_235_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_93_tmp_0);

	float* nearest_interp_v2_21_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_nearest_interp_v2(batch_norm_235_tmp_2, nearest_interp_v2_21_tmp_0, batch_norm_235_tmp_2_dim, nearest_interp_v2_21_tmp_0_dim);
	free(batch_norm_235_tmp_2);

	float* tmp_62 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(tmp_61, nearest_interp_v2_21_tmp_0, tmp_62, tmp_61_dim, nearest_interp_v2_21_tmp_0_dim, tmp_62_dim, -1, 4, 4);
	free(tmp_61);
	free(nearest_interp_v2_21_tmp_0);

	float* batch_norm_236_tmp_2 = (float*)calloc(480, sizeof(float));
	autox_conv2d(reshape2_97_tmp_0, weights + 990440, weights + 990480, batch_norm_236_tmp_2, reshape2_97_tmp_0_dim, conv2d_236_w_0_dim, batch_norm_236_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_97_tmp_0);

	float* nearest_interp_v2_22_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_nearest_interp_v2(batch_norm_236_tmp_2, nearest_interp_v2_22_tmp_0, batch_norm_236_tmp_2_dim, nearest_interp_v2_22_tmp_0_dim);
	free(batch_norm_236_tmp_2);

	float* tmp_63 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(tmp_62, nearest_interp_v2_22_tmp_0, tmp_63, tmp_62_dim, nearest_interp_v2_22_tmp_0_dim, tmp_63_dim, -1, 4, 4);
	free(tmp_62);
	free(nearest_interp_v2_22_tmp_0);

	float* relu_132_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_relu(tmp_63, relu_132_tmp_0, tmp_63_dim, relu_132_tmp_0_dim);
	free(tmp_63);

	float* batch_norm_237_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(tmp_63, weights + 1003280, weights + 1003320, batch_norm_237_tmp_2, tmp_63_dim, conv2d_237_w_0_dim, batch_norm_237_tmp_2_dim, 40, 1, 2, 1, 0);
	free(tmp_63);

	float* batch_norm_238_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(batch_norm_237_tmp_2, weights + 1003680, weights + 1003760, batch_norm_238_tmp_2, batch_norm_237_tmp_2_dim, conv2d_238_w_0_dim, batch_norm_238_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_237_tmp_2);

	float* tmp_64 = (float*)calloc(15360, sizeof(float));
	autox_elementwise_add(batch_norm_238_tmp_2, batch_norm_238_tmp_2, tmp_64, batch_norm_238_tmp_2_dim, batch_norm_238_tmp_2_dim, tmp_64_dim, -1, 4, 4);
	free(batch_norm_238_tmp_2);
	free(batch_norm_238_tmp_2);

	float* tmp_65 = (float*)calloc(15360, sizeof(float));
	autox_elementwise_add(tmp_64, reshape2_89_tmp_0, tmp_65, tmp_64_dim, reshape2_89_tmp_0_dim, tmp_65_dim, -1, 4, 4);
	free(tmp_64);
	free(reshape2_89_tmp_0);

	float* batch_norm_239_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(reshape2_93_tmp_0, weights + 1006960, weights + 1007040, batch_norm_239_tmp_2, reshape2_93_tmp_0_dim, conv2d_239_w_0_dim, batch_norm_239_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_93_tmp_0);

	float* nearest_interp_v2_23_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_nearest_interp_v2(batch_norm_239_tmp_2, nearest_interp_v2_23_tmp_0, batch_norm_239_tmp_2_dim, nearest_interp_v2_23_tmp_0_dim);
	free(batch_norm_239_tmp_2);

	float* tmp_66 = (float*)calloc(15360, sizeof(float));
	autox_elementwise_add(tmp_65, nearest_interp_v2_23_tmp_0, tmp_66, tmp_65_dim, nearest_interp_v2_23_tmp_0_dim, tmp_66_dim, -1, 4, 4);
	free(tmp_65);
	free(nearest_interp_v2_23_tmp_0);

	float* batch_norm_240_tmp_2 = (float*)calloc(960, sizeof(float));
	autox_conv2d(reshape2_97_tmp_0, weights + 1019840, weights + 1019920, batch_norm_240_tmp_2, reshape2_97_tmp_0_dim, conv2d_240_w_0_dim, batch_norm_240_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_97_tmp_0);

	float* nearest_interp_v2_24_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_nearest_interp_v2(batch_norm_240_tmp_2, nearest_interp_v2_24_tmp_0, batch_norm_240_tmp_2_dim, nearest_interp_v2_24_tmp_0_dim);
	free(batch_norm_240_tmp_2);

	float* batch_norm_241_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(tmp_63, weights + 1045520, weights + 1045560, batch_norm_241_tmp_2, tmp_63_dim, conv2d_241_w_0_dim, batch_norm_241_tmp_2_dim, 40, 1, 2, 1, 0);
	free(tmp_63);

	float* relu_134_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_241_tmp_2, weights + 1045920, weights + 1045960, relu_134_tmp_0, batch_norm_241_tmp_2_dim, conv2d_242_w_0_dim, relu_134_tmp_0_dim, 1, 0, 1, 1, 1);
	free(batch_norm_241_tmp_2);

	float* batch_norm_243_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(relu_134_tmp_0, weights + 1047560, weights + 1047600, batch_norm_243_tmp_2, relu_134_tmp_0_dim, conv2d_243_w_0_dim, batch_norm_243_tmp_2_dim, 40, 1, 2, 1, 0);
	free(relu_134_tmp_0);

	float* batch_norm_244_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_243_tmp_2, weights + 1047960, weights + 1048120, batch_norm_244_tmp_2, batch_norm_243_tmp_2_dim, conv2d_244_w_0_dim, batch_norm_244_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_243_tmp_2);

	float* tmp_68 = (float*)calloc(7680, sizeof(float));
	autox_elementwise_add(batch_norm_244_tmp_2, batch_norm_244_tmp_2, tmp_68, batch_norm_244_tmp_2_dim, batch_norm_244_tmp_2_dim, tmp_68_dim, -1, 4, 4);
	free(batch_norm_244_tmp_2);
	free(batch_norm_244_tmp_2);

	float* batch_norm_245_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(reshape2_89_tmp_0, weights + 1054520, weights + 1054600, batch_norm_245_tmp_2, reshape2_89_tmp_0_dim, conv2d_245_w_0_dim, batch_norm_245_tmp_2_dim, 80, 1, 2, 1, 0);
	free(reshape2_89_tmp_0);

	float* batch_norm_246_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_245_tmp_2, weights + 1055320, weights + 1055480, batch_norm_246_tmp_2, batch_norm_245_tmp_2_dim, conv2d_246_w_0_dim, batch_norm_246_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_245_tmp_2);

	float* tmp_69 = (float*)calloc(7680, sizeof(float));
	autox_elementwise_add(tmp_68, batch_norm_246_tmp_2, tmp_69, tmp_68_dim, batch_norm_246_tmp_2_dim, tmp_69_dim, -1, 4, 4);
	free(tmp_68);
	free(batch_norm_246_tmp_2);

	float* tmp_70 = (float*)calloc(7680, sizeof(float));
	autox_elementwise_add(tmp_69, reshape2_93_tmp_0, tmp_70, tmp_69_dim, reshape2_93_tmp_0_dim, tmp_70_dim, -1, 4, 4);
	free(tmp_69);
	free(reshape2_93_tmp_0);

	float* batch_norm_247_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(reshape2_97_tmp_0, weights + 1068280, weights + 1068440, batch_norm_247_tmp_2, reshape2_97_tmp_0_dim, conv2d_247_w_0_dim, batch_norm_247_tmp_2_dim, 1, 0, 1, 1, 0);
	free(reshape2_97_tmp_0);

	float* nearest_interp_v2_25_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_nearest_interp_v2(batch_norm_247_tmp_2, nearest_interp_v2_25_tmp_0, batch_norm_247_tmp_2_dim, nearest_interp_v2_25_tmp_0_dim);
	free(batch_norm_247_tmp_2);

	float* batch_norm_248_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(tmp_63, weights + 1119640, weights + 1119680, batch_norm_248_tmp_2, tmp_63_dim, conv2d_248_w_0_dim, batch_norm_248_tmp_2_dim, 40, 1, 2, 1, 0);
	free(tmp_63);

	float* relu_136_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_248_tmp_2, weights + 1120040, weights + 1120080, relu_136_tmp_0, batch_norm_248_tmp_2_dim, conv2d_249_w_0_dim, relu_136_tmp_0_dim, 1, 0, 1, 1, 1);
	free(batch_norm_248_tmp_2);

	float* batch_norm_250_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(relu_136_tmp_0, weights + 1121680, weights + 1121720, batch_norm_250_tmp_2, relu_136_tmp_0_dim, conv2d_250_w_0_dim, batch_norm_250_tmp_2_dim, 40, 1, 2, 1, 0);
	free(relu_136_tmp_0);

	float* relu_137_tmp_0 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(batch_norm_250_tmp_2, weights + 1122080, weights + 1122120, relu_137_tmp_0, batch_norm_250_tmp_2_dim, conv2d_251_w_0_dim, relu_137_tmp_0_dim, 1, 0, 1, 1, 1);
	free(batch_norm_250_tmp_2);

	float* batch_norm_252_tmp_2 = (float*)calloc(480, sizeof(float));
	autox_conv2d(relu_137_tmp_0, weights + 1123720, weights + 1123760, batch_norm_252_tmp_2, relu_137_tmp_0_dim, conv2d_252_w_0_dim, batch_norm_252_tmp_2_dim, 40, 1, 2, 1, 0);
	free(relu_137_tmp_0);

	float* batch_norm_253_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_252_tmp_2, weights + 1124120, weights + 1124440, batch_norm_253_tmp_2, batch_norm_252_tmp_2_dim, conv2d_253_w_0_dim, batch_norm_253_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_252_tmp_2);

	float* tmp_72 = (float*)calloc(3840, sizeof(float));
	autox_elementwise_add(batch_norm_253_tmp_2, batch_norm_253_tmp_2, tmp_72, batch_norm_253_tmp_2_dim, batch_norm_253_tmp_2_dim, tmp_72_dim, -1, 4, 4);
	free(batch_norm_253_tmp_2);
	free(batch_norm_253_tmp_2);

	float* batch_norm_254_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(reshape2_89_tmp_0, weights + 1137240, weights + 1137320, batch_norm_254_tmp_2, reshape2_89_tmp_0_dim, conv2d_254_w_0_dim, batch_norm_254_tmp_2_dim, 80, 1, 2, 1, 0);
	free(reshape2_89_tmp_0);

	float* relu_138_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_254_tmp_2, weights + 1138040, weights + 1138120, relu_138_tmp_0, batch_norm_254_tmp_2_dim, conv2d_255_w_0_dim, relu_138_tmp_0_dim, 1, 0, 1, 1, 1);
	free(batch_norm_254_tmp_2);

	float* batch_norm_256_tmp_2 = (float*)calloc(960, sizeof(float));
	autox_conv2d(relu_138_tmp_0, weights + 1144520, weights + 1144600, batch_norm_256_tmp_2, relu_138_tmp_0_dim, conv2d_256_w_0_dim, batch_norm_256_tmp_2_dim, 80, 1, 2, 1, 0);
	free(relu_138_tmp_0);

	float* batch_norm_257_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_256_tmp_2, weights + 1145320, weights + 1145640, batch_norm_257_tmp_2, batch_norm_256_tmp_2_dim, conv2d_257_w_0_dim, batch_norm_257_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_256_tmp_2);

	float* tmp_73 = (float*)calloc(3840, sizeof(float));
	autox_elementwise_add(tmp_72, batch_norm_257_tmp_2, tmp_73, tmp_72_dim, batch_norm_257_tmp_2_dim, tmp_73_dim, -1, 4, 4);
	free(tmp_72);
	free(batch_norm_257_tmp_2);

	float* batch_norm_258_tmp_2 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(reshape2_93_tmp_0, weights + 1171240, weights + 1171400, batch_norm_258_tmp_2, reshape2_93_tmp_0_dim, conv2d_258_w_0_dim, batch_norm_258_tmp_2_dim, 160, 1, 2, 1, 0);
	free(reshape2_93_tmp_0);

	float* batch_norm_259_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_258_tmp_2, weights + 1172840, weights + 1173160, batch_norm_259_tmp_2, batch_norm_258_tmp_2_dim, conv2d_259_w_0_dim, batch_norm_259_tmp_2_dim, 1, 0, 1, 1, 0);
	free(batch_norm_258_tmp_2);

	float* tmp_74 = (float*)calloc(3840, sizeof(float));
	autox_elementwise_add(tmp_73, batch_norm_259_tmp_2, tmp_74, tmp_73_dim, batch_norm_259_tmp_2_dim, tmp_74_dim, -1, 4, 4);
	free(tmp_73);
	free(batch_norm_259_tmp_2);

	float* relu_139_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_fusion_elementwise_add_activation(tmp_74, reshape2_97_tmp_0, relu_139_tmp_0, tmp_74_dim, reshape2_97_tmp_0_dim, relu_139_tmp_0_dim, "relu", -1);
	free(tmp_74);
	free(reshape2_97_tmp_0);

	float* batch_norm_260_tmp_2 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(relu_139_tmp_0, weights + 1224360, weights + 1224680, batch_norm_260_tmp_2, relu_139_tmp_0_dim, conv2d_260_w_0_dim, batch_norm_260_tmp_2_dim, 320, 1, 1, 1, 0);
	free(relu_139_tmp_0);

	float* relu_140_tmp_0 = (float*)calloc(1920, sizeof(float));
	autox_conv2d(batch_norm_260_tmp_2, weights + 1227560, weights + 1227720, relu_140_tmp_0, batch_norm_260_tmp_2_dim, conv2d_261_w_0_dim, relu_140_tmp_0_dim, 1, 0, 1, 1, 1);
	free(batch_norm_260_tmp_2);

	float* bilinear_interp_v2_0_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_bilinear_interp_v2(relu_140_tmp_0, bilinear_interp_v2_0_tmp_0, relu_140_tmp_0_dim, bilinear_interp_v2_0_tmp_0_dim);
	free(relu_140_tmp_0);

	float* relu_135_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_fusion_elementwise_add_activation(tmp_70, nearest_interp_v2_25_tmp_0, relu_135_tmp_0, tmp_70_dim, nearest_interp_v2_25_tmp_0_dim, relu_135_tmp_0_dim, "relu", -1);
	free(tmp_70);
	free(nearest_interp_v2_25_tmp_0);

	float* tmp_76 = (float*)calloc(7680, sizeof(float));
	autox_elementwise_add(relu_135_tmp_0, bilinear_interp_v2_0_tmp_0, tmp_76, relu_135_tmp_0_dim, bilinear_interp_v2_0_tmp_0_dim, tmp_76_dim, -1, 4, 4);
	free(relu_135_tmp_0);
	free(bilinear_interp_v2_0_tmp_0);

	float* batch_norm_262_tmp_2 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(tmp_76, weights + 1278920, weights + 1279080, batch_norm_262_tmp_2, tmp_76_dim, conv2d_262_w_0_dim, batch_norm_262_tmp_2_dim, 160, 1, 1, 1, 0);
	free(tmp_76);

	float* relu_141_tmp_0 = (float*)calloc(3840, sizeof(float));
	autox_conv2d(batch_norm_262_tmp_2, weights + 1280520, weights + 1280600, relu_141_tmp_0, batch_norm_262_tmp_2_dim, conv2d_263_w_0_dim, relu_141_tmp_0_dim, 1, 0, 1, 1, 1);
	free(batch_norm_262_tmp_2);

	float* bilinear_interp_v2_1_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_bilinear_interp_v2(relu_141_tmp_0, bilinear_interp_v2_1_tmp_0, relu_141_tmp_0_dim, bilinear_interp_v2_1_tmp_0_dim);
	free(relu_141_tmp_0);

	float* relu_133_tmp_0 = (float*)calloc(15360, sizeof(float));
	autox_fusion_elementwise_add_activation(tmp_66, nearest_interp_v2_24_tmp_0, relu_133_tmp_0, tmp_66_dim, nearest_interp_v2_24_tmp_0_dim, relu_133_tmp_0_dim, "relu", -1);
	free(tmp_66);
	free(nearest_interp_v2_24_tmp_0);

	float* tmp_77 = (float*)calloc(15360, sizeof(float));
	autox_elementwise_add(relu_133_tmp_0, bilinear_interp_v2_1_tmp_0, tmp_77, relu_133_tmp_0_dim, bilinear_interp_v2_1_tmp_0_dim, tmp_77_dim, -1, 4, 4);
	free(relu_133_tmp_0);
	free(bilinear_interp_v2_1_tmp_0);

	float* batch_norm_264_tmp_2 = (float*)calloc(15360, sizeof(float));
	autox_conv2d(tmp_77, weights + 1293400, weights + 1293480, batch_norm_264_tmp_2, tmp_77_dim, conv2d_264_w_0_dim, batch_norm_264_tmp_2_dim, 80, 1, 1, 1, 0);
	free(tmp_77);

	float* relu_142_tmp_0 = (float*)calloc(7680, sizeof(float));
	autox_conv2d(batch_norm_264_tmp_2, weights + 1294200, weights + 1294240, relu_142_tmp_0, batch_norm_264_tmp_2_dim, conv2d_265_w_0_dim, relu_142_tmp_0_dim, 1, 0, 1, 1, 1);
	free(batch_norm_264_tmp_2);

	float* bilinear_interp_v2_2_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_bilinear_interp_v2(relu_142_tmp_0, bilinear_interp_v2_2_tmp_0, relu_142_tmp_0_dim, bilinear_interp_v2_2_tmp_0_dim);
	free(relu_142_tmp_0);

	float* tmp_78 = (float*)calloc(30720, sizeof(float));
	autox_elementwise_add(relu_132_tmp_0, bilinear_interp_v2_2_tmp_0, tmp_78, relu_132_tmp_0_dim, bilinear_interp_v2_2_tmp_0_dim, tmp_78_dim, -1, 4, 4);
	free(relu_132_tmp_0);
	free(bilinear_interp_v2_2_tmp_0);

	float* batch_norm_266_tmp_2 = (float*)calloc(30720, sizeof(float));
	autox_conv2d(tmp_78, weights + 1297440, weights + 1297480, batch_norm_266_tmp_2, tmp_78_dim, conv2d_266_w_0_dim, batch_norm_266_tmp_2_dim, 40, 1, 1, 1, 0);
	free(tmp_78);

	float* relu_143_tmp_0 = (float*)calloc(30720, sizeof(float));
	autox_conv2d(batch_norm_266_tmp_2, weights + 1297840, weights + 1297880, relu_143_tmp_0, batch_norm_266_tmp_2_dim, conv2d_267_w_0_dim, relu_143_tmp_0_dim, 1, 0, 1, 1, 1);
	free(batch_norm_266_tmp_2);

	float* conv2d_441_tmp_1 = (float*)calloc(4608, sizeof(float));
	autox_conv2d(relu_143_tmp_0, weights + 1299480, weights + 1299486, conv2d_441_tmp_1, relu_143_tmp_0_dim, conv2d_268_w_0_dim, conv2d_441_tmp_1_dim, 1, 0, 1, 1, 0);
	free(relu_143_tmp_0);

	float* argmax_0_tmp_0 = (float*)calloc(6, sizeof(float));
	autox_argmax(reshape2_98_tmp_0, argmax_0_tmp_0, reshape2_98_tmp_0_dim, argmax_0_tmp_0_dim, 0);
	free(reshape2_98_tmp_0);
}
