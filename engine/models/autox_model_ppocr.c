...
void japan_PP_OCRv3_rec(const uint8_t* image, const uint16_t ssize_h, const uint16_t ssize_w, float* weights, float* Out)
{
	...
	float* x = (float*)calloc(3 * 48 * 224, sizeof(float));
	...
	//autox_elementwise_mul(batch_norm_23_tmp_4, hardsigmoid_0_tmp_0, elementwise_mul_0, batch_norm_23_tmp_4_dim, hardsigmoid_0_tmp_0_dim, elementwise_mul_0_dim, -1, 4, 4, 4);
	//free(batch_norm_23_tmp_4);
	...
	//autox_hard_sigmoid(conv2d_53_tmp_1, conv2d_53_tmp_1_dim, 0.5, 0.1666667);

	//float* elementwise_mul_1 = (float*)calloc(1536, sizeof(float));
	//autox_elementwise_mul(batch_norm_25_tmp_4, hardsigmoid_1_tmp_0, elementwise_mul_1, batch_norm_25_tmp_4_dim, hardsigmoid_1_tmp_0_dim, elementwise_mul_1_dim, -1, 4, 4, 4);
	//free(batch_norm_25_tmp_4);
	...
	//autox_swish(batch_norm_27_tmp_2, batch_norm_27_tmp_2_dim, 1.0);
	...
	//autox_swish(batch_norm_28_tmp_2, batch_norm_28_tmp_2_dim, 1.0);
	...
	//autox_layer_norm(transpose_0_tmp_0, weights + 1313464, weights + 1313584, layer_norm_5_tmp_0, transpose_0_tmp_0_dim, layer_norm_0_b_0_dim, layer_norm_0_w_0_dim, layer_norm_5_tmp_0_dim, 2, 1e-05);
	//free(transpose_0_tmp_0);

	//float* linear_13_tmp_0 = (float*)calloc(360, sizeof(float));
	//autox_matmul(layer_norm_5_tmp_2, weights + 1313704, linear_13_tmp_0, layer_norm_5_tmp_2_dim, linear_0_w_0_dim, linear_13_tmp_0_dim, 0, 0, 3, 2, 3);
	//free(layer_norm_5_tmp_2);

	//float* linear_13_tmp_1 = (float*)calloc(360, sizeof(float));
	//autox_elementwise_add(linear_13_tmp_0, weights + 1356904, linear_13_tmp_1, linear_13_tmp_0_dim, linear_0_b_0_dim, linear_13_tmp_1_dim, 2, 3, 1, 3);
	...
	//autox_scale(transpose_1_tmp_0_slice_0, transpose_1_tmp_0_slice_0_dim, 0, 1, 0.2581989);
	...
	//autox_matmul(tmp_0, transpose_2_tmp_0, matmul_v2_0_tmp_0, tmp_0_dim, transpose_2_tmp_0_dim, matmul_v2_0_tmp_0_dim, 0, 0, 4, 4, 4);
	//free(tmp_0);
	...
	//autox_matmul(dropout_7_tmp_0, transpose_1_tmp_0_slice_2, matmul_v2_1_tmp_0, dropout_7_tmp_0_dim, transpose_1_tmp_0_slice_2_dim, matmul_v2_1_tmp_0_dim, 0, 0, 4, 4, 4);
	...
	//autox_matmul(reshape2_1_tmp_0, weights + 1357264, linear_14_tmp_0, reshape2_1_tmp_0_dim, linear_1_w_0_dim, linear_14_tmp_0_dim, 0, 0, 3, 2, 3);
	//free(reshape2_1_tmp_0);

	//float* dropout_8_tmp_0 = (float*)calloc(120, sizeof(float));
	//autox_elementwise_add(linear_14_tmp_0, weights + 1371664, dropout_8_tmp_0, linear_14_tmp_0_dim, linear_1_b_0_dim, dropout_8_tmp_0_dim, 2, 3, 1, 3);
	...
	//autox_layer_norm(tmp_1, weights + 1371784, weights + 1371904, layer_norm_6_tmp_0, tmp_1_dim, layer_norm_1_b_0_dim, layer_norm_1_w_0_dim, layer_norm_6_tmp_0_dim, 2, 1e-05);
	//free(tmp_1);

	//float* linear_15_tmp_0 = (float*)calloc(240, sizeof(float));
	//autox_matmul(layer_norm_6_tmp_2, weights + 1372024, linear_15_tmp_0, layer_norm_6_tmp_2_dim, linear_2_w_0_dim, linear_15_tmp_0_dim, 0, 0, 3, 2, 3);
	//free(layer_norm_6_tmp_2);

	//float* linear_15_tmp_1 = (float*)calloc(240, sizeof(float));
	//autox_elementwise_add(linear_15_tmp_0, weights + 1400824, linear_15_tmp_1, linear_15_tmp_0_dim, linear_2_b_0_dim, linear_15_tmp_1_dim, 2, 3, 1, 3);
	//free(linear_15_tmp_0);

	//autox_swish(linear_15_tmp_1, linear_15_tmp_1_dim, 1.0);

	//float* linear_16_tmp_0 = (float*)calloc(120, sizeof(float));
	//autox_matmul(dropout_9_tmp_0, weights + 1401064, linear_16_tmp_0, dropout_9_tmp_0_dim, linear_3_w_0_dim, linear_16_tmp_0_dim, 0, 0, 3, 2, 3);
	//free(dropout_9_tmp_0);

	//float* dropout_10_tmp_0 = (float*)calloc(120, sizeof(float));
	//autox_elementwise_add(linear_16_tmp_0, weights + 1429864, dropout_10_tmp_0, linear_16_tmp_0_dim, linear_3_b_0_dim, dropout_10_tmp_0_dim, 2, 3, 1, 3);
	...
	//autox_layer_norm(tmp_2, weights + 1429984, weights + 1430104, layer_norm_7_tmp_0, tmp_2_dim, layer_norm_2_b_0_dim, layer_norm_2_w_0_dim, layer_norm_7_tmp_0_dim, 2, 1e-05);
	//free(tmp_2);

	//float* linear_17_tmp_0 = (float*)calloc(360, sizeof(float));
	//autox_matmul(layer_norm_7_tmp_2, weights + 1430224, linear_17_tmp_0, layer_norm_7_tmp_2_dim, linear_4_w_0_dim, linear_17_tmp_0_dim, 0, 0, 3, 2, 3);
	//free(layer_norm_7_tmp_2);

	//float* linear_17_tmp_1 = (float*)calloc(360, sizeof(float));
	//autox_elementwise_add(linear_17_tmp_0, weights + 1473424, linear_17_tmp_1, linear_17_tmp_0_dim, linear_4_b_0_dim, linear_17_tmp_1_dim, 2, 3, 1, 3);
	...
	//autox_scale(transpose_4_tmp_0_slice_0, transpose_4_tmp_0_slice_0_dim, 0, 1, 0.2581989);
	...
	//autox_matmul(tmp_3, transpose_5_tmp_0, matmul_v2_2_tmp_0, tmp_3_dim, transpose_5_tmp_0_dim, matmul_v2_2_tmp_0_dim, 0, 0, 4, 4, 4);
	//free(tmp_3);
	...
	//autox_matmul(dropout_11_tmp_0, transpose_4_tmp_0_slice_2, matmul_v2_3_tmp_0, dropout_11_tmp_0_dim, transpose_4_tmp_0_slice_2_dim, matmul_v2_3_tmp_0_dim, 0, 0, 4, 4, 4);
	...
	//autox_matmul(reshape2_3_tmp_0, weights + 1473784, linear_18_tmp_0, reshape2_3_tmp_0_dim, linear_5_w_0_dim, linear_18_tmp_0_dim, 0, 0, 3, 2, 3);
	//free(reshape2_3_tmp_0);

	//float* dropout_12_tmp_0 = (float*)calloc(120, sizeof(float));
	//autox_elementwise_add(linear_18_tmp_0, weights + 1488184, dropout_12_tmp_0, linear_18_tmp_0_dim, linear_5_b_0_dim, dropout_12_tmp_0_dim, 2, 3, 1, 3);
	...
	//autox_layer_norm(tmp_4, weights + 1488304, weights + 1488424, layer_norm_8_tmp_0, tmp_4_dim, layer_norm_3_b_0_dim, layer_norm_3_w_0_dim, layer_norm_8_tmp_0_dim, 2, 1e-05);
	//free(tmp_4);

	//float* linear_19_tmp_0 = (float*)calloc(240, sizeof(float));
	//autox_matmul(layer_norm_8_tmp_2, weights + 1488544, linear_19_tmp_0, layer_norm_8_tmp_2_dim, linear_6_w_0_dim, linear_19_tmp_0_dim, 0, 0, 3, 2, 3);
	//free(layer_norm_8_tmp_2);

	//float* linear_19_tmp_1 = (float*)calloc(240, sizeof(float));
	//autox_elementwise_add(linear_19_tmp_0, weights + 1517344, linear_19_tmp_1, linear_19_tmp_0_dim, linear_6_b_0_dim, linear_19_tmp_1_dim, 2, 3, 1, 3);
	//free(linear_19_tmp_0);

	//autox_swish(linear_19_tmp_1, linear_19_tmp_1_dim, 1.0);

	//float* linear_20_tmp_0 = (float*)calloc(120, sizeof(float));
	//autox_matmul(dropout_13_tmp_0, weights + 1517584, linear_20_tmp_0, dropout_13_tmp_0_dim, linear_7_w_0_dim, linear_20_tmp_0_dim, 0, 0, 3, 2, 3);
	//free(dropout_13_tmp_0);

	//float* dropout_14_tmp_0 = (float*)calloc(120, sizeof(float));
	//autox_elementwise_add(linear_20_tmp_0, weights + 1546384, dropout_14_tmp_0, linear_20_tmp_0_dim, linear_7_b_0_dim, dropout_14_tmp_0_dim, 2, 3, 1, 3);
	...
	//autox_layer_norm(tmp_5, weights + 1546504, weights + 1546624, layer_norm_9_tmp_0, tmp_5_dim, layer_norm_4_b_0_dim, layer_norm_4_w_0_dim, layer_norm_9_tmp_0_dim, 2, 1e-06);
	//free(tmp_5);
	...
	//autox_swish(batch_norm_29_tmp_2, batch_norm_29_tmp_2_dim, 1.0);
	...
	//autox_swish(batch_norm_30_tmp_2, batch_norm_30_tmp_2_dim, 1.0);
	...
	//autox_swish(batch_norm_31_tmp_2, batch_norm_31_tmp_2_dim, 1.0);
	...
	//autox_matmul(transpose_8_tmp_0, weights + 2202744, linear_21_tmp_0, transpose_8_tmp_0_dim, linear_8_w_0_dim, linear_21_tmp_0_dim, 0, 0, 3, 2, 3);
	//free(transpose_8_tmp_0);

	//float* linear_21_tmp_1 = (float*)calloc(4401, sizeof(float));
	//autox_elementwise_add(linear_21_tmp_0, weights + 2484408, linear_21_tmp_1, linear_21_tmp_0_dim, linear_8_b_0_dim, linear_21_tmp_1_dim, 2, 3, 1, 3);
