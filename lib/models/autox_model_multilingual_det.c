...
void multilingual_det(const float* x, void* weights, float* Out)
{
	...
	autox_conv2d(hardswish_19_tmp_0, NULL, (float*)((int8_t*)weights) + 392296, conv2d_250_tmp_0, hardswish_19_tmp_0_dim, conv2d_65_w_0_dim, conv2d_250_tmp_0_dim, 1, 0, 1, 1, 0);
	...
	autox_elementwise_mul(conv2d_250_tmp_0, conv2d_252_tmp_1, tmp_0, conv2d_250_tmp_0_dim, hardsigmoid_0_tmp_0_dim, tmp_0_dim, -1, 4, 4, 4);
	//free(conv2d_250_tmp_0);
	free(conv2d_252_tmp_1);
	...
	autox_conv2d(elementwise_add_7, NULL, (float*)((int8_t*)weights) + 443104, conv2d_253_tmp_0, elementwise_add_7_dim, conv2d_59_w_0_dim, conv2d_253_tmp_0_dim, 1, 0, 1, 1, 0);
	free(elementwise_add_7);
	...
	autox_elementwise_mul(conv2d_253_tmp_0, conv2d_255_tmp_1, tmp_2, conv2d_253_tmp_0_dim, hardsigmoid_1_tmp_0_dim, tmp_2_dim, -1, 4, 4, 4);
	//free(conv2d_253_tmp_0);
	free(conv2d_255_tmp_1);
	...
	autox_conv2d(elementwise_add_3, NULL, (float*)((int8_t*)weights) + 453208, conv2d_256_tmp_0, elementwise_add_3_dim, conv2d_53_w_0_dim, conv2d_256_tmp_0_dim, 1, 0, 1, 1, 0);
	free(elementwise_add_3);
	...
	autox_elementwise_mul(conv2d_256_tmp_0, conv2d_258_tmp_1, tmp_4, conv2d_256_tmp_0_dim, hardsigmoid_2_tmp_0_dim, tmp_4_dim, -1, 4, 4, 4);
	//free(conv2d_256_tmp_0);
	free(conv2d_258_tmp_1);
	...
	autox_conv2d(elementwise_add_1, NULL, (float*)((int8_t*)weights) + 460240, conv2d_259_tmp_0, elementwise_add_1_dim, conv2d_47_w_0_dim, conv2d_259_tmp_0_dim, 1, 0, 1, 1, 0);
	free(elementwise_add_1);
	...
	autox_elementwise_mul(conv2d_259_tmp_0, conv2d_261_tmp_1, tmp_6, conv2d_259_tmp_0_dim, hardsigmoid_3_tmp_0_dim, tmp_6_dim, -1, 4, 4, 4);
	//free(conv2d_259_tmp_0);
	free(conv2d_261_tmp_1);
	...
	autox_conv2d(tmp_1, NULL, (float*)((int8_t*)weights) + 466504, conv2d_262_tmp_0, tmp_1_dim, conv2d_68_w_0_dim, conv2d_262_tmp_0_dim, 1, 1, 1, 1, 0);
	free(tmp_1);
	...
	autox_elementwise_mul(conv2d_262_tmp_0, conv2d_264_tmp_1, tmp_11, conv2d_262_tmp_0_dim, hardsigmoid_4_tmp_0_dim, tmp_11_dim, -1, 4, 4, 4);
	//free(conv2d_262_tmp_0);
	free(conv2d_264_tmp_1);
	...
	autox_conv2d(tmp_8, NULL, (float*)((int8_t*)weights) + 487558, conv2d_265_tmp_0, tmp_8_dim, conv2d_62_w_0_dim, conv2d_265_tmp_0_dim, 1, 1, 1, 1, 0);
	free(tmp_8);
	...
	autox_elementwise_mul(conv2d_265_tmp_0, conv2d_267_tmp_1, tmp_13, conv2d_265_tmp_0_dim, hardsigmoid_5_tmp_0_dim, tmp_13_dim, -1, 4, 4, 4);
	//free(conv2d_265_tmp_0);
	free(conv2d_267_tmp_1);
	...
	autox_conv2d(tmp_9, NULL, (float*)((int8_t*)weights) + 508612, conv2d_268_tmp_0, tmp_9_dim, conv2d_56_w_0_dim, conv2d_268_tmp_0_dim, 1, 1, 1, 1, 0);
	free(tmp_9);
	...
	autox_elementwise_mul(conv2d_268_tmp_0, conv2d_270_tmp_1, tmp_15, conv2d_268_tmp_0_dim, hardsigmoid_6_tmp_0_dim, tmp_15_dim, -1, 4, 4, 4);
	//free(conv2d_268_tmp_0);
	free(conv2d_270_tmp_1);
	...
	autox_conv2d(tmp_10, NULL, (float*)((int8_t*)weights) + 529666, conv2d_271_tmp_0, tmp_10_dim, conv2d_50_w_0_dim, conv2d_271_tmp_0_dim, 1, 1, 1, 1, 0);
	free(tmp_10);
	...
	autox_elementwise_mul(conv2d_271_tmp_0, conv2d_273_tmp_1, tmp_17, conv2d_271_tmp_0_dim, hardsigmoid_7_tmp_0_dim, tmp_17_dim, -1, 4, 4, 4);
	//free(conv2d_271_tmp_0);
	free(conv2d_273_tmp_1);
	...
	autox_conv2d_transpose(batch_norm_48_tmp_4, (float*)((int8_t*)weights) + 573808, (float*)((int8_t*)weights) + 573809, Out, batch_norm_48_tmp_4_dim, conv2d_transpose_1_w_0_dim, elementwise_add_11_tmp_0_dim, 1, 0, 2, 1, 0);
	free(batch_norm_48_tmp_4);

	autox_sigmoid(Out, elementwise_add_11_tmp_0_dim, 4);
}
